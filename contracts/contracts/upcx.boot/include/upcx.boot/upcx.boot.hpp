...
namespace upcxboot {
   ...
   /**
    * @defgroup upcxboot upcx.boot
    * @ingroup upcxcontracts
    *
    * upcx.boot is a extremely minimalistic system contract that only supports the native actions and an
    * activate action that allows activating desired protocol features prior to deploying a system contract
    * with more features such as upcx.bios or upcx.system.
    *
    * @{
    */
   class [[upcx::contract("upcx.boot")]] boot : public upcx::contract {
      public:
   ...
   /** @}*/ // end of @defgroup upcxboot upcx.boot
} /// namespace upcxboot
