...
namespace upcxioboot {
   ...
   /**
    * @defgroup upcxioboot upcxio.boot
    * @ingroup upcxiocontracts
    *
    * upcxio.boot is a extremely minimalistic system contract that only supports the native actions and an
    * activate action that allows activating desired protocol features prior to deploying a system contract
    * with more features such as upcxio.bios or upcxio.system.
    *
    * @{
    */
   class [[upcxio::contract("upcxio.boot")]] boot : public upcxio::contract {
      public:
   ...
   /** @}*/ // end of @defgroup upcxioboot upcxio.boot
} /// namespace upcxioboot
