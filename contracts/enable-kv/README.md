...
1. export EOS_2_1_0=[upcx 2.1.0 directory]
1. export EOSIO_CDT_1_8_0=[upcxio.cdt 1.8.0 directory]
...
1. make
1. cleos create account upcxio jane EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
