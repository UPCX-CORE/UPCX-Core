...
This section contains shell commands to manually download, build, install, test, and uninstall UPCX and dependencies on Amazon Linux 2.
...
cd $UPCX_BUILD_LOCATION && $UPCX_INSTALL_LOCATION/bin/cmake -DCMAKE_BUILD_TYPE='Release' -DCMAKE_CXX_COMPILER='clang++' -DCMAKE_C_COMPILER='clang' -DCMAKE_INSTALL_PREFIX=$UPCX_INSTALL_LOCATION $UPCX_LOCATION
