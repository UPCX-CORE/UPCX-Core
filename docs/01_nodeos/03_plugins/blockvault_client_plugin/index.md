...
```sh
# command-line
nodeos ... --plugin upcxio::blockvault_client_plugin [options]
```
...
```sh
nodeos --plugin upcxio::producer_plugin --producer-name myproducer --plugin upcxio::blockvault_client_plugin --block-vault-backend postgresql://user:password@mycompany.com
```
...
nodeos --plugin upcxio::producer_plugin --producer-name myproducer --plugin upcxio::blockvault_client_plugin --block-vault-backend postgresql://user@mycompany.com
```
