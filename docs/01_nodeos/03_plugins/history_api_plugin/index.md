...
[[info | More Info]]
| See HISTORY section of [RPC API](https://developers.upcx.io/upcxio-nodeos/reference).
...
```sh
# command-line
nodeos ... --plugin upcxio::history_api_plugin
```
...
```sh
# command-line
nodeos ... --plugin upcxio::history_plugin [options]  \
