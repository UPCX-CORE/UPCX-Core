...
See [Net API Reference Documentation](https://developers.upcx.io/manuals/upcx/latest/nodeos/plugins/net_api_plugin/api-reference/index).
...
```console
# config.ini
plugin = upcxio::net_api_plugin
```

```sh
# command-line
nodeos ... --plugin upcxio::net_api_plugin
```
...
```sh
# command-line
nodeos ... --plugin upcxio::net_plugin [options]  \
