...
To stay informed about the overall and detailed performance of your UPCX-based blockchain node(s), you can make use of the telemetry tools available. UPCX offers integration with two such telemetry tools:
