...
# ID of producer controlled by this node (e.g. inita; may specify multiple times) (upcx::producer_plugin)
...
- `public-key` - A valid UPCX public key in form of a string.
