...
```sh
nodupcx -e -p upcxio --plugin upcxio::producer_plugin --plugin upcxio::producer_api_plugin --plugin upcxio::chain_api_plugin --access-control-allow-origin='*' --contracts-console --http-validate-host=false --verbose-http-errors
```
...
At this point, `nodupcx` is running with a single producer, `upcxio`.
...
```sh
clupcx set contract upcxio UPCXIO_SYSTEM_CONTRACTS_DIRECTORY/upcxio.boot/bin/ upcxio.boot.wasm upcxio.boot.abi
```
...
```sh
echo KV_DATABASE
clupcx push action upcxio activate '["825ee6288fb1373eab1b5187ec2f04f6eacb39cb3a97f356a07c91622dd61d16"]' -p upcxio

echo ACTION_RETURN_VALUE
clupcx push action upcxio activate '["c3a6138c5061cf291310887c0b5c71fcaffeab90d5deb50d3b9e687cead45071"]' -p upcxio

echo CONFIGURABLE_WASM_LIMITS
clupcx push action upcxio activate '["bf61537fd21c61a60e542a5d66c3f6a78da0589336868307f94a82bccea84e88"]' -p upcxio

echo BLOCKCHAIN_PARAMETERS
clupcx push action upcxio activate '["5443fcf88330c586bc0e5f3dee10e7f63c76c00249c87fe4fbf7f38c082006b4"]' -p upcxio

echo GET_SENDER
clupcx push action upcxio activate '["f0af56d2c5a48d60a4a5b5c903edfb7db3a736a94ed589d0b797df33ff9d3e1d"]' -p upcxio

echo FORWARD_SETCODE
clupcx push action upcxio activate '["2652f5f96006294109b3dd0bbde63693f55324af452b799ee137a81a905eed25"]' -p upcxio

echo ONLY_BILL_FIRST_AUTHORIZER
clupcx push action upcxio activate '["8ba52fe7a3956c5cd3a656a3174b931d3bb2abb45578befc59f283ecd816a405"]' -p upcxio

echo RESTRICT_ACTION_TO_SELF
clupcx push action upcxio activate '["ad9e3d8f650687709fd68f4b90b41f7d825a365b02c23a636cef88ac2ac00c43"]' -p upcxio

echo DISALLOW_EMPTY_PRODUCER_SCHEDULE
clupcx push action upcxio activate '["68dcaa34c0517d19666e6b33add67351d8c5f69e999ca1e37931bc410a297428"]' -p upcxio

 echo FIX_LINKAUTH_RESTRICTION
clupcx push action upcxio activate '["e0fb64b1085cc5538970158d05a009c24e276fb94e1a0bf6a528b48fbc4ff526"]' -p upcxio

 echo REPLACE_DEFERRED
clupcx push action upcxio activate '["ef43112c6543b88db2283a2e077278c315ae2c84719a8b25f25cc88565fbea99"]' -p upcxio

echo NO_DUPLICATE_DEFERRED_ID
clupcx push action upcxio activate '["4a90c00d55454dc5b059055ca213579c6ea856967712a56017487886a4d4cc0f"]' -p upcxio

echo ONLY_LINK_TO_EXISTING_PERMISSION
clupcx push action upcxio activate '["1a99a59d87e06e09ec5b028a9cbb7749b4a5ad8819004365d02dc4379a8b7241"]' -p upcxio

echo RAM_RESTRICTIONS
clupcx push action upcxio activate '["4e7bf348da00a945489b2a681749eb56f5de00b900014e137ddae39f48f69d67"]' -p upcxio

echo WEBAUTHN_KEY
clupcx push action upcxio activate '["4fca8bd82bbd181e714e283f83e1b45d95ca5af40fb89ad3977b653c448f78c2"]' -p upcxio

echo WTMSIG_BLOCK_SIGNATURES
clupcx push action upcxio activate '["299dcb6af692324b899b39f16d5a530a33062804e41f09dc97e9f156b4476707"]' -p upcxio
```
...
```sh
clupcx set contract upcxio UPCXIO_SYSTEM_CONTRACTS_DIRECTORY/upcxio.bios/bin/ upcxio.bios.wasm upcxio.bios.abi
```
...
```sh
clupcx set contract upcxio UPCXIO_SYSTEM_CONTRACTS_DIRECTORY/upcxio.system/ upcxio.system.wasm upcxio.system.abi
```
