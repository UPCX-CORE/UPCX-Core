...
There are several ways to configure a `nodupcx` environment for development and testing. Which option to use largely depends on what the project goals are. Some practical options are provided below.
...
- [Configure Nodupcx as a Local Single-node Testnet](00_local-single-node-testnet.md)
...
- [Configure Nodupcx as a Local Single-node Testnet with Consensus Protocol](10_local-single-node-testnet-consensus.md)
...
- [Configure Nodupcx as a Local 21-Node Testnet](https://github.com/UPCXIO/upcx/blob/master/tutorials/bios-boot-tutorial/README.md)

## Official Testnet

The official testnet is available for testing UPCXIO dApps and smart contracts:

- [testnet.upcx.io](https://testnet.upcx.io/)

## Third-Party Testnets

The following third-party testnets are available for testing UPCXIO dApps and smart contracts:
