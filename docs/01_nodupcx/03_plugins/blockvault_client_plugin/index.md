...
```console
# config.ini
plugin = upcxio::blockvault_client_plugin
[options]
```

```sh
# command-line
nodupcx ... --plugin upcxio::blockvault_client_plugin [options]
```
...
```console
Config Options for upcxio::blockvault_client_plugin:
...
```sh
nodupcx --plugin upcxio::producer_plugin --producer-name myproducer --plugin upcxio::blockvault_client_plugin --block-vault-backend postgresql://user:password@mycompany.com
```
...
nodupcx --plugin upcxio::producer_plugin --producer-name myproducer --plugin upcxio::blockvault_client_plugin --block-vault-backend postgresql://user@mycompany.com
```

## Software Dependencies

To build `blockvault_client_plugin` you need `libpq` version 10 or above and `libpqxx` version 6 or above. These dependencies are typically installed (alongside other dependencies) when you either [Install UPCXIO](../../../00_install/index.md) from prebuilt binaries or build from source. You may also opt to install these dependencies manually prior to installing or building UPCXIO.
...
- [`async_propose_constructed_block()`](../../../classupcxio_1_1blockvault_1_1block__vault__interface#function-async_propose_constructed_block)
- [`async_append_external_block()`](../../../classupcxio_1_1blockvault_1_1block__vault__interface#function-async_append_external_block)
- [`propose_snapshot()`](../../../classupcxio_1_1blockvault_1_1block__vault__interface#function-propose_snapshot)
- [`sync()`](../../../classupcxio_1_1blockvault_1_1block__vault__interface#function-sync)

For more information visit the [block_vault_interface](../../../classupcxio_1_1blockvault_1_1block__vault__interface) C++ reference.
