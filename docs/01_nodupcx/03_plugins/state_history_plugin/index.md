...
```sh
# command-line
nodupcx ... --plugin upcxio::state_history_plugin [operations] [options]
```
...
```console
Command Line Options for upcxio::state_history_plugin:
...
```console
Config Options for upcxio::state_history_plugin:
...
- [Source code](https://github.com/UPCXIO/history-tools/)
- [Documentation](https://upcxio.github.io/history-tools/)
...
```console
# config.ini
plugin = upcxio::chain_plugin --disable-replay-opts
```

```sh
# command-line
nodupcx ... --plugin upcxio::chain_plugin --disable-replay-opts
```
