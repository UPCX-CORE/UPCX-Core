...
```sh
# command-line
nodupcx ... --plugin upcx::trace_api_plugin [options]
```
...
```console
Config Options for upcx::trace_api_plugin:
...
```sh
# command-line
nodupcx ... --plugin upcx::chain_plugin [options]  \
           --plugin upcx::http_plugin [options]
```

## Configuration Example

Here is a `nodupcx` configuration example for the `trace_api_plugin` when tracing some UPCX reference contracts:

```sh
nodupcx --data-dir data_dir --config-dir config_dir --trace-dir traces_dir
--plugin upcx::trace_api_plugin
--trace-rpc-abi=upcx=abis/upcx.abi
--trace-rpc-abi=upcx.token=abis/upcx.token.abi
--trace-rpc-abi=upcx.msig=abis/upcx.msig.abi
--trace-rpc-abi=upcx.wrap=abis/upcx.wrap.abi
```
