...
To stay informed about the overall and detailed performance of your UPCXIO-based blockchain node(s), you can make use of the telemetry tools available. UPCXIO offers integration with two such telemetry tools:
