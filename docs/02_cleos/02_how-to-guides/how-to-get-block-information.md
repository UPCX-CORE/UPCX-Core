...
- Understand the [block lifecycle](https://developers.upcx.io/welcome/v2.1/protocol-guides/consensus_protocol/#5-block-lifecycle) in the UPCXIO consensus protocol.
...
```sh
cleos -u https://api.testnet.upcx.io get block 48351112
```
...
```sh
cleos -u https://api.testnet.upcx.io get block 02e1c7888a92206573ae38d00e09366c7ba7bc54cd8b7996506f7d2a619c43ba
```
