...
- The [cleos system voteproducer prods](https://developers.upcx.io/manuals/upcx/v2.1/cleos/command-reference/system/system-voteproducer-prods) reference.
...
```sh
cleos system voteproducer prods upcxiotestts2 blockproducer1 blockproducer2
```
