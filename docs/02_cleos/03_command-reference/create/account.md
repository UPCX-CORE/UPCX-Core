...
A set of UPCXIO keys is required to create an account. The UPCXIO keys can be generated by using `cleos create key`.

```sh
cleos create account inita tester UPCX4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq UPCX7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
