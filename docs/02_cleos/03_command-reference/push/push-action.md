...
```shell
> cleos push action upcxio rstring '{"str":null}'  -p upcxio@active
...
> cleos push action upcxio rstring '{"str":"test"}'  -p upcxio@active
...
> cleos push action upcxio ruint '{"i":42}'  -p upcxio@active
...
```shell
> cleos push action upcxio rtmp '{}'  -p upcxio@active
...
```shell
> cleos push action upcxio rstring '{"str":"qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq"}'  -p upcxio@active
