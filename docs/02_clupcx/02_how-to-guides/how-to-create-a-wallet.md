...
Create a wallet using `kupcxd`.

## Before you begin

Make sure you meet the following requirements:

- Familiarize with the [`clupcx wallet create`](../03_command-reference/wallet/create.md) command and its parameters.
- Familiarize with the other [`clupcx wallet`](../03_command-reference/wallet/index.md) commands.
- Install the currently supported version of `clupcx`.

[[info | Note]]
| `clupcx` is bundled with the UPCXIO software. [Installing UPCXIO](../../00_install/index.md) will also install `clupcx`.
...
```sh
clupcx wallet create [-n named_wallet] -f <file_to_save_pwd>
```
...
```sh
clupcx wallet create -n my_wallet -f my_wallet.pwd
```
