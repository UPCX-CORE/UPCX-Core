...
This how-to guide provides instructions on how to transfer tokens created by `upcx.token` contract.
...
In conclusion, the above instructions show how to transfer tokens created by `upcx.token` contract from one account to another.
