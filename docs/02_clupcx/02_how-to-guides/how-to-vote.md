...
1. How to vote for blockproducer1 and blockproducer2 from an account called `upcxtestts2`:

```sh
clupcx system voteproducer prods upcxtestts2 blockproducer1 blockproducer2
```

Where:

- `upcxtestts2` = the account that votes.
...
#         upcx <= upcx::voteproducer          {"voter":"upcxtestts2","proxy":"","producers":["blockproducer1","blockproducer2"]}
```
