...
```sh
clupcx net connect [OPTIONS] host
```
...
The following information shows the different positionals and options you can use with the `clupcx net connect` command:
...
The following examples demonstrate how to use the `clupcx net connect` command:
...
```sh
clupcx net connect localhost:9002
```
...
```sh
clupcx -u http://127.0.0.1:8001 net connect localhost:9002
```
