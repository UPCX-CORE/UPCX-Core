...
#         upcx <= upcx::linkauth              {"account":"bob","code":"scontract1","type":"hi","requirement":"customp1"}
```
...
```shell
executed transaction: 4eb4cf3aea232d46e0e949bc273c3f0575be5bdba7b61851ab51d927cf74a838  128 bytes  141 us
#         upcx <= upcx::linkauth              {"account":"bob","code":"scontract1","type":"bye","requirement":"customp2"}
```
...
#         upcx <= upcx::unlinkauth            {"account":"bob","code":"scontract1","type":"hi"}
```
