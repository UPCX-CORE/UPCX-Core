...
`keosd` is distributed as part of the [UPCXIO software suite](https://github.com/UPCXIO/upcx/blob/master/README.md). To install `keosd` just visit the [UPCXIO Software Installation](../00_install/index.md) section.
...
[[info | Audience]]
| `keosd` is intended to be used by UPCXIO developers only.
