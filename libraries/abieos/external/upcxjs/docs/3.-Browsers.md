...
Reuse the `api` object for all transactions; it caches ABIs to reduce network usage. Only call `new upcxjs_api.Api(...)` once.

```html
<pre style="width: 100%; height: 100%; margin:0px; "></pre>

<script src="dist-web/upcxjs-api.js"></script>
<script src="dist-web/upcxjs-jsonrpc.js"></script>
<script src="dist-web/upcxjs-jssig.js"></script>
<script>
