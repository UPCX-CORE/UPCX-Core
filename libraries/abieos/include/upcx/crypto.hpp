...
UPCX_REFLECT(webauthn_public_key, key, user_presence, rpid);
UPCX_COMPARE(webauthn_public_key);
...
UPCX_REFLECT(webauthn_signature, compact_signature, auth_data, client_json);
UPCX_COMPARE(webauthn_signature);
