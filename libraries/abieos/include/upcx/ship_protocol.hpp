...
namespace upcx { namespace ship_protocol {
...
#   pragma clang diagnostic ignored "-Winvalid-noreturn"
   [[noreturn]] inline void report_error(const std::string& s) { upcx::check(false, s); }
#   pragma clang diagnostic pop
   ...
   struct extension {
      uint16_t            type = {};
      upcx::input_stream data = {};
   };

   UPCX_REFLECT(extension, type, data)
   ...
   // todo: switch to upcx::result. switch to new serializer string support.
   ...
   UPCX_REFLECT(get_status_request_v0)
   ...
   UPCX_REFLECT(block_position, block_num, block_id)
   ...
   struct get_status_result_v0 {
      ...
      upcx::checksum256 chain_id                = {}; // todo: switch to binary extension
   };

   UPCX_REFLECT(get_status_result_v0, head, last_irreversible, trace_begin_block, trace_end_block,
   ...
   // `get_blocks_result_v1` will be returned for UPCX version 2.1 RC bug not stable. 
   ...
   UPCX_REFLECT(get_blocks_request_v0, start_block_num, end_block_num, max_messages_in_flight, have_positions,
   ...
   UPCX_REFLECT(get_blocks_request_v1, base get_blocks_request_v0, fetch_block_header)

   struct get_blocks_ack_request_v0 {
      uint32_t num_messages = {};
   };

   UPCX_REFLECT(get_blocks_ack_request_v0, num_messages)
   ...
   UPCX_REFLECT(get_blocks_result_base, head, last_irreversible, this_block, prev_block)

   struct get_blocks_result_v0 : get_blocks_result_base {
      std::optional<upcx::input_stream> block  = {};
      std::optional<upcx::input_stream> traces = {};
      std::optional<upcx::input_stream> deltas = {};
   };

   UPCX_REFLECT(get_blocks_result_v0, base get_blocks_result_base, block, traces, deltas)
   ...
   UPCX_REFLECT(row_v0, present, data)
   ...
   UPCX_REFLECT(table_delta_v0, name, rows)
   ...
   UPCX_REFLECT(row_v1, present, data)
   ...
   UPCX_REFLECT(table_delta_v1, name, rows)
   ...
   UPCX_REFLECT(permission_level, actor, permission)
   ...
   UPCX_REFLECT(action, account, name, authorization, data)
   ...
   UPCX_REFLECT(account_auth_sequence, account, sequence)
   UPCX_COMPARE(account_auth_sequence);

   struct action_receipt_v0 {
      upcx::name                        receiver        = {};
      upcx::checksum256                 act_digest      = {};
      uint64_t                           global_sequence = {};
      uint64_t                           recv_sequence   = {};
      std::vector<account_auth_sequence> auth_sequence   = {};
      upcx::varuint32                   code_sequence   = {};
      upcx::varuint32                   abi_sequence    = {};
   };

   UPCX_REFLECT(action_receipt_v0, receiver, act_digest, global_sequence, recv_sequence, auth_sequence, code_sequence,
                 abi_sequence)
   ...
   UPCX_REFLECT(account_delta, account, delta)
   UPCX_COMPARE(account_delta);

   struct action_trace_v0 {
      upcx::varuint32              action_ordinal         = {};
      upcx::varuint32              creator_action_ordinal = {};
   ...
   UPCX_REFLECT(action_trace_v0, action_ordinal, creator_action_ordinal, receipt, receiver, act, context_free, elapsed,
   ...
   struct action_trace_v1 {
      ...
      std::optional<std::string>    except                 = {};
      std::optional<uint64_t>       error_code             = {};
      upcx::input_stream           return_value           = {};
   };

   UPCX_REFLECT(action_trace_v1, action_ordinal, creator_action_ordinal, receipt, receiver, act, context_free, elapsed,
   ...
   struct prunable_data_type {
      struct none {
         upcx::checksum256 prunable_digest;
      };

      using segment_type = std::variant<upcx::checksum256, upcx::input_stream>;

      struct partial {
         std::vector<upcx::signature> signatures;
         std::vector<segment_type>     context_free_segments;
      };

      struct full {
         std::vector<upcx::signature>    signatures;
         std::vector<upcx::input_stream> context_free_segments;
      };

      struct full_legacy {
         std::vector<upcx::signature> signatures;
         upcx::input_stream           packed_context_free_data;
      };
   ...
   UPCX_REFLECT(prunable_data_type, prunable_data)
   UPCX_REFLECT(prunable_data_type::none, prunable_digest)
   UPCX_REFLECT(prunable_data_type::partial, signatures, context_free_segments)
   UPCX_REFLECT(prunable_data_type::full, signatures, context_free_segments)
   UPCX_REFLECT(prunable_data_type::full_legacy, signatures, packed_context_free_data)

   struct partial_transaction_v0 {
      upcx::time_point_sec            expiration             = {};
      uint16_t                         ref_block_num          = {};
      uint32_t                         ref_block_prefix       = {};
      upcx::varuint32                 max_net_usage_words    = {};
      uint8_t                          max_cpu_usage_ms       = {};
      upcx::varuint32                 delay_sec              = {};
      std::vector<extension>           transaction_extensions = {};
      std::vector<upcx::signature>    signatures             = {};
      std::vector<upcx::input_stream> context_free_data      = {};
   };

   UPCX_REFLECT(partial_transaction_v0, expiration, ref_block_num, ref_block_prefix, max_net_usage_words,
   ...
   UPCX_REFLECT(partial_transaction_v1, expiration, ref_block_num, ref_block_prefix, max_net_usage_words,
   ...
   struct transaction_trace_v0 {
      ...
      upcx::varuint32                       net_usage_words   = {};
      int64_t                                elapsed           = {};
      uint64_t                               net_usage         = {};
      bool                                   scheduled         = {};
   ...
   UPCX_REFLECT(transaction_trace_v0, id, status, cpu_usage_us, net_usage_words, elapsed, net_usage, scheduled,
   ...
   struct producer_key {
      upcx::name       producer_name     = {};
      upcx::public_key block_signing_key = {};
   };

   UPCX_REFLECT(producer_key, producer_name, block_signing_key)
   ...
   UPCX_REFLECT(producer_schedule, version, producers)
   ...
   UPCX_REFLECT(transaction_receipt_header, status, cpu_usage_us, net_usage_words)

   struct packed_transaction_v0 {
      std::vector<upcx::signature> signatures               = {};
      uint8_t                       compression              = {};
      upcx::input_stream           packed_context_free_data = {};
      upcx::input_stream           packed_trx               = {};
   };

   UPCX_REFLECT(packed_transaction_v0, signatures, compression, packed_context_free_data, packed_trx)
   ...
   UPCX_REFLECT(packed_transaction, compression, prunable_data, packed_trx)

   using transaction_variant_v0 = std::variant<upcx::checksum256, packed_transaction_v0>;

   struct transaction_receipt_v0 : transaction_receipt_header {
      transaction_variant_v0 trx = {};
   };

   UPCX_REFLECT(transaction_receipt_v0, base transaction_receipt_header, trx)

   using transaction_variant = std::variant<upcx::checksum256, packed_transaction>;

   struct transaction_receipt : transaction_receipt_header {
      transaction_variant trx = {};
   };

   UPCX_REFLECT(transaction_receipt, base transaction_receipt_header, trx)
   ...
   UPCX_REFLECT(block_header, timestamp, producer, confirmed, previous, transaction_mroot, action_mroot,
   ...
   UPCX_REFLECT(signed_block_header, base block_header, producer_signature)
   ...
   UPCX_REFLECT(signed_block_v0, base signed_block_header, transactions, block_extensions)
   ...
   UPCX_REFLECT(signed_block_v1, base signed_block_header, prune_state, transactions, block_extensions)
   ...
   struct get_blocks_result_v1 : get_blocks_result_base {
      ...
      upcx::opaque<std::vector<transaction_trace>> traces = {};
      upcx::opaque<std::vector<table_delta>>       deltas = {};
   };

   UPCX_REFLECT(get_blocks_result_v1, base get_blocks_result_base, block, traces, deltas)

   struct get_blocks_result_v2 : get_blocks_result_base { 
      upcx::opaque<signed_block_variant>           block = {};
      upcx::opaque<signed_block_header>            block_header = {};
      upcx::opaque<std::vector<transaction_trace>> traces = {};
      upcx::opaque<std::vector<table_delta>>       deltas = {};
   };

   UPCX_REFLECT(get_blocks_result_v2, base get_blocks_result_base, block, block_header, traces, deltas)
   ...
   UPCX_REFLECT(transaction_header, expiration, ref_block_num, ref_block_prefix, max_net_usage_words, max_cpu_usage_ms,
                 delay_sec)
   ...
   UPCX_REFLECT(transaction, base transaction_header, context_free_actions, actions, transaction_extensions)

   struct code_id {
      uint8_t            vm_type    = {};
      uint8_t            vm_version = {};
      upcx::checksum256 code_hash  = {};
   };

   UPCX_REFLECT(code_id, vm_type, vm_version, code_hash)

   struct account_v0 {
      upcx::name            name          = {};
      upcx::block_timestamp creation_date = {};
      upcx::input_stream    abi           = {};
   };

   UPCX_REFLECT(account_v0, name, creation_date, abi)
   ...
   struct account_metadata_v0 {
      upcx::name            name             = {};
      bool                   privileged       = {};
      upcx::time_point      last_code_update = {};
      std::optional<code_id> code             = {};
   };

   UPCX_REFLECT(account_metadata_v0, name, privileged, last_code_update, code)
   ...
   struct code_v0 {
      ...
      uint8_t             vm_version = {};
      upcx::checksum256  code_hash  = {};
      upcx::input_stream code       = {};
   };

   UPCX_REFLECT(code_v0, vm_type, vm_version, code_hash, code)
   ...
   UPCX_REFLECT(contract_table_v0, code, scope, table, payer)
   ...
   struct contract_row_v0 {
      ...
      upcx::name         payer       = {};
      upcx::input_stream value       = {};
   };

   UPCX_REFLECT(contract_row_v0, code, scope, table, primary_key, payer, value)
   ...
   UPCX_REFLECT(contract_index64_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   UPCX_REFLECT(contract_index128_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   struct contract_index256_v0 {
      ...
      uint64_t           primary_key   = {};
      upcx::name        payer         = {};
      upcx::checksum256 secondary_key = {};
   };

   UPCX_REFLECT(contract_index256_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   UPCX_REFLECT(contract_index_double_v0, code, scope, table, primary_key, payer, secondary_key)
   ...
   struct contract_index_long_double_v0 {
      ...
      uint64_t        primary_key   = {};
      upcx::name     payer         = {};
      upcx::float128 secondary_key = {};
   };

   UPCX_REFLECT(contract_index_long_double_v0, code, scope, table, primary_key, payer, secondary_key)

   using contract_index_long_double = std::variant<contract_index_long_double_v0>;

   struct key_value_v0 {
      upcx::name         contract = {};
      upcx::input_stream key      = {};
      upcx::input_stream value    = {};
      upcx::name         payer    = {};
   };

   UPCX_REFLECT(key_value_v0, contract, key, value, payer)
   ...
   UPCX_REFLECT(key_weight, key, weight)
   ...
   UPCX_REFLECT(block_signing_authority_v0, threshold, keys)
   ...
   UPCX_REFLECT(producer_authority, producer_name, authority)
   ...
   UPCX_REFLECT(producer_authority_schedule, version, producers)
   ...
   UPCX_REFLECT(chain_config_v0, max_block_net_usage, target_block_net_usage_pct, max_transaction_net_usage,
   ...
   UPCX_REFLECT(chain_config_v1, max_block_net_usage, target_block_net_usage_pct, max_transaction_net_usage,
               base_per_transaction_net_usage, net_usage_leeway, context_free_discount_net_usage_num,
               context_free_discount_net_usage_den, max_block_cpu_usage, target_block_cpu_usage_pct,
               max_transaction_cpu_usage, min_transaction_cpu_usage, max_transaction_lifetime,
               deferred_trx_expiration_window, max_transaction_delay, max_inline_action_size, max_inline_action_depth,
   ...
   UPCX_REFLECT(global_property_v0, proposed_schedule_block_num, proposed_schedule, configuration)
   ...
   UPCX_REFLECT(global_property_v1, proposed_schedule_block_num, proposed_schedule, configuration, chain_id)
   ...
   UPCX_REFLECT(kv_database_config, max_key_size, max_value_size, max_iterators)
   ...
   UPCX_REFLECT(wasm_config, max_mutable_global_bytes, max_table_elements, max_section_elements,
   ...
   struct generated_transaction_v0 {
      ...
      uint128_t           sender_id  = {};
      upcx::name         payer      = {};
      upcx::checksum256  trx_id     = {};
      upcx::input_stream packed_trx = {};
   };

   UPCX_REFLECT(generated_transaction_v0, sender, sender_id, payer, trx_id, packed_trx)

   using generated_transaction = std::variant<generated_transaction_v0>;

   struct activated_protocol_feature_v0 {
      upcx::checksum256 feature_digest       = {};
      uint32_t           activation_block_num = {};
   };

   UPCX_REFLECT(activated_protocol_feature_v0, feature_digest, activation_block_num)
   ...
   UPCX_REFLECT(protocol_state_v0, activated_protocol_features)
   ...
   UPCX_REFLECT(permission_level_weight, permission, weight)
   ...
   UPCX_REFLECT(wait_weight, wait_sec, weight)
   ...
   UPCX_REFLECT(authority, threshold, keys, accounts, waits)

   struct permission_v0 {
      upcx::name       owner        = {};
      upcx::name       name         = {};
      upcx::name       parent       = {};
      upcx::time_point last_updated = {};
      authority         auth         = {};
   };

   UPCX_REFLECT(permission_v0, owner, name, parent, last_updated, auth)
   ...
   struct permission_link_v0 {
      upcx::name account             = {};
      upcx::name code                = {};
      upcx::name message_type        = {};
      upcx::name required_permission = {};
   };

   UPCX_REFLECT(permission_link_v0, account, code, message_type, required_permission)
   ...
   UPCX_REFLECT(resource_limits_v0, owner, net_weight, cpu_weight, ram_bytes)
   ...
   UPCX_REFLECT(usage_accumulator_v0, last_ordinal, value_ex, consumed)
   ...
   UPCX_REFLECT(resource_usage_v0, owner, net_usage, cpu_usage, ram_usage)
   ...
   UPCX_REFLECT(resource_limits_state_v0, average_block_net_usage, average_block_cpu_usage, total_net_weight,
   ...
   UPCX_REFLECT(resource_limits_ratio_v0, numerator, denominator)
   ...
   UPCX_REFLECT(elastic_limit_parameters_v0, target, max, periods, max_multiplier, contract_rate, expand_rate)
   ...
   UPCX_REFLECT(resource_limits_config_v0, cpu_limit_parameters, net_limit_parameters,
...
namespace upcx {
   ...
   void to_json(const ship_protocol::transaction_status& status, S& stream) {
      ...
      return upcx::to_json((uint8_t)status, stream);
   }

   template <typename S>
   void from_json(ship_protocol::transaction_status& status, S& stream) {
      uint8_t v;
      upcx::from_json(v, stream);
