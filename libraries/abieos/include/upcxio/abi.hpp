...
constexpr inline std::string_view convert_abi_error(upcxio::abi_error e) {
   switch (e) {
...
struct abi {
   std::map<upcxio::name, std::string> action_types;
   std::map<upcxio::name, std::string> table_types;
   std::map<upcxio::name, std::string> kv_tables;
   std::map<std::string, abi_type>    abi_types;
   std::map<upcxio::name, std::string> action_result_types;
