...
namespace upcxio { namespace ship_protocol {
...
#   pragma clang diagnostic ignored "-Winvalid-noreturn"
   [[noreturn]] inline void report_error(const std::string& s) { upcxio::check(false, s); }
#   pragma clang diagnostic pop
   ...
   // todo: switch to upcxio::result. switch to new serializer string support.
   ...
   struct get_blocks_result_v0 : get_blocks_result_base {
      ...
      std::optional<upcxio::input_stream> traces = {};
   ...
   struct action_receipt_v0 {
      ...
      upcxio::checksum256                 act_digest      = {};
      uint64_t                           global_sequence = {};
      uint64_t                           recv_sequence   = {};
      std::vector<account_auth_sequence> auth_sequence   = {};
      upcxio::varuint32                   code_sequence   = {};
   ...
   struct action_trace_v0 {
      ...
      upcxio::varuint32              creator_action_ordinal = {};
   ...
   struct prunable_data_type {
      struct none {
         upcxio::checksum256 prunable_digest;
      };

      using segment_type = std::variant<upcxio::checksum256, upcxio::input_stream>;
      ...
      struct full {
         std::vector<upcxio::signature>    signatures;
         std::vector<upcxio::input_stream> context_free_segments;
      };

      struct full_legacy {
         std::vector<upcxio::signature> signatures;
         upcxio::input_stream           packed_context_free_data;
      };
   ...
   struct partial_transaction_v0 {
      ...
      upcxio::varuint32                 max_net_usage_words    = {};
   ...
   struct get_blocks_result_v1 : get_blocks_result_base {
      ...
      upcxio::opaque<std::vector<transaction_trace>> traces = {};
   ...
   struct get_blocks_result_v2 : get_blocks_result_base { 
      ...
      upcxio::opaque<signed_block_header>            block_header = {};
      upcxio::opaque<std::vector<transaction_trace>> traces = {};
      upcxio::opaque<std::vector<table_delta>>       deltas = {};
   };
   ...
   struct account_v0 {
      upcxio::name            name          = {};
      upcxio::block_timestamp creation_date = {};
   ...
   struct account_metadata_v0 {
      upcxio::name            name             = {};
      bool                   privileged       = {};
      upcxio::time_point      last_code_update = {};
   ...
   struct key_value_v0 {
      upcxio::name         contract = {};
      upcxio::input_stream key      = {};
      upcxio::input_stream value    = {};
      upcxio::name         payer    = {};
   };
   ...
   struct activated_protocol_feature_v0 {
      upcxio::checksum256 feature_digest       = {};
   ...
   struct permission_v0 {
      ...
      upcxio::name       name         = {};
      upcxio::name       parent       = {};
      upcxio::time_point last_updated = {};
      authority         auth         = {};
   };
...
}} // namespace upcxio::ship_protocol
...
namespace upcxio {
   ...
   void to_json(const ship_protocol::transaction_status& status, S& stream) {
      ...
      return upcxio::to_json((uint8_t)status, stream);
   }

   template <typename S>
   void from_json(ship_protocol::transaction_status& status, S& stream) {
      uint8_t v;
      upcxio::from_json(v, stream);
