...
describe("upcxjs web test", () => {
  ...
  it("test Transact With Config Blocks Behind", () => {
    ...
    cy.get("#testTransactWithConfigBlocksBehind").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test Transact With Config Use Last Irreversible", () => {
    ...
    cy.get("#testTransactWithConfigUseLastIrreversible").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test Transact With Compression", () => {
    ...
    cy.get("#testTransactWithCompression").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test Transact With Context Free Action", () => {
    ...
    cy.get("#testTransactWithContextFreeAction").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test Transact With Context Free Data", () => {
    ...
    cy.get("#testTransactWithContextFreeData").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test Transact Without Broadcast", () => {
    ...
    cy.get("#testTransactWithoutBroadcast").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test Shorthand With Tx Json Context Free Action", () => {
    ...
    cy.get("#testShorthandWithTxJsonContextFreeAction").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test Shorthand With Tx Json Context Free Data", () => {
    ...
    cy.get("#testShorthandWithTxJsonContextFreeData").contains("Success", {
      timeout: 5000,
    });
  });
  ...
  it("test With Read Only Failure Trace", () => {
    ...
    cy.get("#testWithReadOnlyFailureTrace").contains("Success", {
      timeout: 5000,
    });
  });
