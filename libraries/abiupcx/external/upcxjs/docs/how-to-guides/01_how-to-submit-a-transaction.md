...
(async () => {
  ...
  tx.associateContextFree((index) => ({
    ...
    contextFreeAction: tx
      .with("account")
      .as()
      .cfaName(index.cfd, "context free example"),
