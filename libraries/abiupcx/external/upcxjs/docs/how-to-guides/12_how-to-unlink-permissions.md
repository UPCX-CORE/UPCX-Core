To unlink an existing permission, [submit a transaction](01_how-to-submit-a-transaction.md) to the [`unlinkauth`](https://github.com/upcx/upcx.contracts/blob/52fbd4ac7e6c38c558302c48d00469a4bed35f7c/contracts/upcx.bios/include/upcx.bios/upcx.bios.hpp#L255) action of the `upcx` account.
