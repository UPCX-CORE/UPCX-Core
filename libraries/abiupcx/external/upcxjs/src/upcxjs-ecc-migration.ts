import { PrivateKey, PublicKey, Signature } from "./upcxjs-jssig";
import { generateKeyPair } from "./upcxjs-key-conversions";
import { KeyType } from "./upcxjs-numeric";
...
export const ecc = {
  ...
  sha256: (
    ...
    return require("./upcxjs-key-conversions").sha256(data);
  },
};
