...
import { TransactionHeader } from "./upcxjs-api-interfaces";
import { Abi, BlockTaposInfo } from "./upcxjs-rpc-interfaces";
import { Query } from "./upcxjs-api-interfaces";
 ...
 *          * Else, value must be upcxjs-compatible with the specified type (e.g. uint64 should be a string
