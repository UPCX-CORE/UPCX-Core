...
function check_types() {
  ...
  check_throw("Error: Unsupported abi version", () =>
    upcxjs_hex_abi_to_json(upcxjs_json_abi_to_hex({ version: "upcx::abi/9.0" }))
  );
  upcxjs_hex_abi_to_json(upcxjs_json_abi_to_hex({ version: "upcx::abi/1.0" }));
  upcxjs_hex_abi_to_json(upcxjs_json_abi_to_hex({ version: "upcx::abi/1.1" }));
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX1111111111111111111111111111111114T1Anm"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX11111111111111111111111115qCHTcgbQwptSz99m"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX111111111111111114ZrjxJnU1LA5xSyrWMNuXTrYSJ57"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX1111111113diW7pnisfdBvHTXP7wvW5k5Ky1e5DVuF23dosU"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX11DsZ6Lyr1aXpm9aBqqgV4iFJpNbSw5eE9LLTwNAxqjJgmjgbT"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX12wkBET2rRgE8pahuaczxKbmv7ciehqsne57F9gtzf1PVYNMRa2"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX1yp8ebBuKZ13orqUrZsGsP49e6K3ThVK1nLutxSyU5j9SaXz9a"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX9adaAMuB9v8yX1mZ5PtoB6VFSCeqRGjASd8ZTM6VUkiHL7mue4K"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX69X3383RzBZj41k73CSjUNXM5MYGpnDxyPnWUKPEtYQmTBWz4D"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX7yBtksm8Kkg85r4in4uCbfN77uRwe82apM8jjbhFVDgEgz3w8S"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX7WnhaKwHpbSidYuh2DF1qAExTRUtPEdZCaZqt75cKcixuQUtdA"',
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"UPCX7Bn1YDeZ18w2N9DU4KAJxZDt6hk3L7eUwFRAc1hb5bp6xJwxNV"',
...
async function push_transfer() {
  if (useTokenHexApi)
    check(
      l.abiupcx_set_abi_hex(context, name("upcx.token"), cstr(tokenHexApi))
    );
  else
    check(
      l.abiupcx_set_abi(
        context,
        name("upcx.token"),
        jsonStr((await rpc.get_abi("upcx.token")).abi)
      )
    );
  let type = checkPtr(
    l.abiupcx_get_type_for_action(context, name("upcx.token"), name("transfer"))
  );
  check(
  ...
  console.log(
    "action bin->json: ",
    abiupcx_hex_to_json(name("upcx.token"), "transfer", actionDataHex)
  );
