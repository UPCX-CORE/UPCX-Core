...
namespace upcx { namespace chain { namespace backing_store {
   ...
   upcx::session::shared_bytes make_useless_value() {
      const char null = '\0';
      return upcx::session::shared_bytes {&null, 1};
   }

   const upcx::session::shared_bytes db_key_value_any_lookup::useless_value = make_useless_value();
