...
#include <upcx/chain/log_data_base.hpp>
#include <upcx/chain/log_index.hpp>
#include <upcx/chain/log_catalog.hpp>
#include <upcx/chain/block_log_config.hpp>
...
namespace upcx { namespace chain {
   ...
   using block_log_index = upcx::chain::log_index<block_log_exception>;
   ...
   using block_log_catalog = upcx::chain::log_catalog<block_log_data, block_log_index, block_log_verifier>;
