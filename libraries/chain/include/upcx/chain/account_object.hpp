...
namespace upcx { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const upcx::chain::abi_def& a ) {
      ...
      upcx::chain::abi_def get_abi()const {
         upcx::chain::abi_def a;
...
CHAINBASE_SET_INDEX_TYPE(upcx::chain::account_object, upcx::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::account_metadata_object, upcx::chain::account_metadata_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::account_ram_correction_object, upcx::chain::account_ram_correction_index)

FC_REFLECT(upcx::chain::account_object, (name)(creation_date)(abi))
FC_REFLECT(upcx::chain::account_metadata_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence)
                                                  (code_hash)(last_code_update)(flags)(vm_type)(vm_version))
FC_REFLECT(upcx::chain::account_ram_correction_object, (name)(ram_correction))
