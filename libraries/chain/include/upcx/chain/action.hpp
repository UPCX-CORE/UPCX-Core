...
namespace upcx { namespace chain {
    ...
    *  In the context of upcx, every action is dispatched to the handler defined
...
FC_REFLECT( upcx::chain::permission_level, (actor)(permission) )
FC_REFLECT( upcx::chain::action_base, (account)(name)(authorization) )
FC_REFLECT_DERIVED( upcx::chain::action, (upcx::chain::action_base), (data) )
