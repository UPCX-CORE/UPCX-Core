...
namespace fc {
inline void to_variant(const upcx::chain::asset& var, fc::variant& vo) { vo = var.to_string(); }
inline void from_variant(const fc::variant& var, upcx::chain::asset& vo) {
   vo = upcx::chain::asset::from_string(var.get_string());
}
}

namespace fc {
inline void from_variant(const fc::variant& var, upcx::chain::extended_asset& vo) {
   if( var.is_array() ) {
...
FC_REFLECT(upcx::chain::asset, (amount)(sym))
FC_REFLECT(upcx::chain::extended_asset, (quantity)(contract) )
