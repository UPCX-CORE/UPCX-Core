...
FC_REFLECT(upcx::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(upcx::chain::key_weight, (key)(weight) )
FC_REFLECT(upcx::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(upcx::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(upcx::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(upcx::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(upcx::chain::shared_public_key, (pubkey))
