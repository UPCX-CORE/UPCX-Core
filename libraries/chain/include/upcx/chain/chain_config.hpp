...
#include <upcx/chain/chain_config_helper.hpp>
...
FC_REFLECT(upcx::chain::chain_config_v0,
...
FC_REFLECT_DERIVED(upcx::chain::chain_config_v1, (upcx::chain::chain_config_v0), 
...
inline DataStream &operator<<(DataStream &s, const upcx::chain::data_entry<upcx::chain::chain_config_v0, upcx::chain::config_entry_validator> &entry){
 ...
 */
template <typename DataStream>
inline DataStream &operator<<(DataStream &s, const upcx::chain::data_entry<upcx::chain::chain_config_v1, upcx::chain::config_entry_validator> &entry){
   using namespace upcx::chain;
 ...
 */
template <typename DataStream>
inline DataStream &operator>>(DataStream &s, upcx::chain::data_entry<upcx::chain::chain_config_v0, upcx::chain::config_entry_validator> &entry){
   using namespace upcx::chain;

   UPCX_ASSERT(entry.is_allowed(), upcx::chain::unsupported_feature, "config id ${id} is no allowed", ("id", entry.id));
   ...
   switch (entry.id){
      ...
      break;
      default:
      FC_THROW_EXCEPTION(upcx::chain::config_parse_error, "DataStream& operator<<: no such id: ${id}", ("id", entry.id));
   }
 ...
 */
template <typename DataStream>
inline DataStream &operator>>(DataStream &s, upcx::chain::data_entry<upcx::chain::chain_config_v1, upcx::chain::config_entry_validator> &entry){
   using namespace upcx::chain;
   ...
   switch (entry.id){
      ...
      break;
      default:
      upcx::chain::data_entry<chain_config_v0, config_entry_validator> base_entry(entry);
...
inline DataStream& operator<<( DataStream& s, const upcx::chain::data_range<T, upcx::chain::config_entry_validator>& selection ) {
   using namespace upcx::chain;
 ...
 */
template<typename DataStream, typename T>
inline DataStream& operator>>( DataStream& s, upcx::chain::data_range<T, upcx::chain::config_entry_validator>& selection ) {
   using namespace upcx::chain;
