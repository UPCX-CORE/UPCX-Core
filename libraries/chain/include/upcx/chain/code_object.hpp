...
CHAINBASE_SET_INDEX_TYPE(upcx::chain::code_object, upcx::chain::code_index)

FC_REFLECT(upcx::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
