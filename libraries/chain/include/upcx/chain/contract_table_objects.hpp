...
#include <upcx/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(upcx::chain::table_id_object, upcx::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::key_value_object, upcx::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(upcx::chain::index64_object, upcx::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::index128_object, upcx::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::index256_object, upcx::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::index_double_object, upcx::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::index_long_double_object, upcx::chain::index_long_double_index)

FC_REFLECT(upcx::chain::table_id_object, (code)(scope)(table)(payer)(count) )
// @ignore t_id
FC_REFLECT(upcx::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(upcx::chain::index64_object)
REFLECT_SECONDARY(upcx::chain::index128_object)
REFLECT_SECONDARY(upcx::chain::index256_object)
REFLECT_SECONDARY(upcx::chain::index_double_object)
REFLECT_SECONDARY(upcx::chain::index_long_double_object)
