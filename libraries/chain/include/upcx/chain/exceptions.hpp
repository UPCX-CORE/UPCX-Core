 ...
 * The main difference here is that if the exception caught isn't of type "upcx::chain::chain_exception"
...
#define UPCX_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
      ...
      throw;\
   } catch (upcx::chain::chain_exception& e) { \
...
namespace upcx { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( upcx_assert_message_exception, action_validate_exception,
                                    3050003, "upcx_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( upcx_assert_code_exception, action_validate_exception,
                                    3050004, "upcx_assert_code assertion failure" )
      ...
      FC_DECLARE_DERIVED_EXCEPTION( restricted_error_code_exception, action_validate_exception,
                                    3050011, "upcx_assert_code assertion failure uses restricted error code value" )
