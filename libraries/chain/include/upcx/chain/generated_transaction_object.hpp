...
CHAINBASE_SET_INDEX_TYPE(upcx::chain::generated_transaction_object, upcx::chain::generated_transaction_multi_index)

FC_REFLECT(upcx::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
