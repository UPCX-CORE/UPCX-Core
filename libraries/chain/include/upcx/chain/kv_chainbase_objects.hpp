...
CHAINBASE_SET_INDEX_TYPE(upcx::chain::kv_db_config_object, upcx::chain::kv_db_config_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::kv_object, upcx::chain::kv_index)
FC_REFLECT(upcx::chain::kv_db_config_object, (backing_store))
FC_REFLECT(upcx::chain::kv_object_view, (contract)(kv_key)(kv_value)(payer))
FC_REFLECT(upcx::chain::kv_object, (contract)(kv_key)(kv_value)(payer))
