...
CHAINBASE_SET_INDEX_TYPE(upcx::chain::permission_link_object, upcx::chain::permission_link_index)

FC_REFLECT(upcx::chain::permission_link_object, (account)(code)(message_type)(required_permission))
