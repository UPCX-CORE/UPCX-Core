...
CHAINBASE_SET_INDEX_TYPE(upcx::chain::permission_object, upcx::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(upcx::chain::permission_usage_object, upcx::chain::permission_usage_index)

FC_REFLECT(upcx::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(upcx::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(upcx::chain::permission_usage_object, (last_used))
