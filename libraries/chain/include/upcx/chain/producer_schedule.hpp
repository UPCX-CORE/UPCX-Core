...
FC_REFLECT( upcx::chain::legacy::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( upcx::chain::legacy::producer_schedule_type, (version)(producers) )
FC_REFLECT( upcx::chain::block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( upcx::chain::producer_authority, (producer_name)(authority) )
FC_REFLECT( upcx::chain::producer_authority_schedule, (version)(producers) )
FC_REFLECT_DERIVED( upcx::chain::producer_schedule_change_extension, (upcx::chain::producer_authority_schedule), )

FC_REFLECT( upcx::chain::shared_block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( upcx::chain::shared_producer_authority, (producer_name)(authority) )
FC_REFLECT( upcx::chain::shared_producer_authority_schedule, (version)(producers) )
