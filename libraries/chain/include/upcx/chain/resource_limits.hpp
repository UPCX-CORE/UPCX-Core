...
FC_REFLECT( upcx::chain::resource_limits::account_resource_limit, (used)(available)(max)(last_usage_update_time)(current_used) )
FC_REFLECT( upcx::chain::resource_limits::ratio, (numerator)(denominator))
FC_REFLECT( upcx::chain::resource_limits::elastic_limit_parameters, (target)(max)(periods)(max_multiplier)(contract_rate)(expand_rate))
