...
#include <upcx/chain/action_receipt.hpp>
...
FC_REFLECT( upcx::chain::account_delta,
            (account)(delta) )

FC_REFLECT( upcx::chain::action_trace,
...
// @ignore except_ptr
FC_REFLECT( upcx::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
