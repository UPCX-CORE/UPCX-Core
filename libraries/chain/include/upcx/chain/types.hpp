...
namespace upcx { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in UPCX code:
    *
    ...
    *  others are due to requirements to ensure determinism in the UPCX chain library.
    *
...
FC_REFLECT_EMPTY( upcx::chain::void_t )
