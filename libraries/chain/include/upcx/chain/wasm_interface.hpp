...
namespace upcx { namespace chain {
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against UPCX specific constraints
...
FC_REFLECT_ENUM( upcx::chain::wasm_interface::vm_type, (upcx_vm)(upcx_vm_jit)(upcx_vm_oc) )
