...
inline constexpr auto get_intrinsic_table() {
   return detail::generate_table(
      ...
      "upcx_injection.call_depth_assert",  //these two are never used by UPCX VM OC but all intrinsics
      "upcx_injection.checktime",          //must be mapped
      "env.__ashlti3",
      "env.__ashrti3",
      "env.__lshlti3",
      "env.__lshrti3",
      ...
      "env.abort",
      "env.upcx_assert",
      "env.upcx_assert_message",
      "env.upcx_assert_code",
      "env.upcx_exit",
      ...
      "env.memcmp",
      "env.memset",
      "upcx_injection._upcx_f32_add",
      "upcx_injection._upcx_f32_sub",
      "upcx_injection._upcx_f32_mul",
      "upcx_injection._upcx_f32_div",
      "upcx_injection._upcx_f32_min",
      "upcx_injection._upcx_f32_max",
      "upcx_injection._upcx_f32_copysign",
      "upcx_injection._upcx_f32_abs",
      "upcx_injection._upcx_f32_neg",
      "upcx_injection._upcx_f32_sqrt",
      "upcx_injection._upcx_f32_ceil",
      "upcx_injection._upcx_f32_floor",
      "upcx_injection._upcx_f32_trunc",
      "upcx_injection._upcx_f32_nearest",
      "upcx_injection._upcx_f32_eq",
      "upcx_injection._upcx_f32_ne",
      "upcx_injection._upcx_f32_lt",
      "upcx_injection._upcx_f32_le",
      "upcx_injection._upcx_f32_gt",
      "upcx_injection._upcx_f32_ge",
      "upcx_injection._upcx_f64_add",
      "upcx_injection._upcx_f64_sub",
      "upcx_injection._upcx_f64_mul",
      "upcx_injection._upcx_f64_div",
      "upcx_injection._upcx_f64_min",
      "upcx_injection._upcx_f64_max",
      "upcx_injection._upcx_f64_copysign",
      "upcx_injection._upcx_f64_abs",
      "upcx_injection._upcx_f64_neg",
      "upcx_injection._upcx_f64_sqrt",
      "upcx_injection._upcx_f64_ceil",
      "upcx_injection._upcx_f64_floor",
      "upcx_injection._upcx_f64_trunc",
      "upcx_injection._upcx_f64_nearest",
      "upcx_injection._upcx_f64_eq",
      "upcx_injection._upcx_f64_ne",
      "upcx_injection._upcx_f64_lt",
      "upcx_injection._upcx_f64_le",
      "upcx_injection._upcx_f64_gt",
      "upcx_injection._upcx_f64_ge",
      "upcx_injection._upcx_f32_promote",
      "upcx_injection._upcx_f64_demote",
      "upcx_injection._upcx_f32_trunc_i32s",
      "upcx_injection._upcx_f64_trunc_i32s",
      "upcx_injection._upcx_f32_trunc_i32u",
      "upcx_injection._upcx_f64_trunc_i32u",
      "upcx_injection._upcx_f32_trunc_i64s",
      "upcx_injection._upcx_f64_trunc_i64s",
      "upcx_injection._upcx_f32_trunc_i64u",
      "upcx_injection._upcx_f64_trunc_i64u",
      "upcx_injection._upcx_i32_to_f32",
      "upcx_injection._upcx_i64_to_f32",
      "upcx_injection._upcx_ui32_to_f32",
      "upcx_injection._upcx_ui64_to_f32",
      "upcx_injection._upcx_i32_to_f64",
      "upcx_injection._upcx_i64_to_f64",
      "upcx_injection._upcx_ui32_to_f64",
      "upcx_injection._upcx_ui64_to_f64",
