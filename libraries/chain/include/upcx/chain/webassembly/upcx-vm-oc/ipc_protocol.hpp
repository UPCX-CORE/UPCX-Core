...
struct code_tuple {
   upcx::chain::digest_type code_id;
   uint8_t vm_version;
...
FC_REFLECT(upcx::chain::upcxvmoc::initialize_message, )
FC_REFLECT(upcx::chain::upcxvmoc::initalize_response_message, (error_message))
FC_REFLECT(upcx::chain::upcxvmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(upcx::chain::upcxvmoc::compile_wasm_message, (code))
FC_REFLECT(upcx::chain::upcxvmoc::evict_wasms_message, (codes))
FC_REFLECT(upcx::chain::upcxvmoc::code_compilation_result_message, (start)(apply_offset)(starting_memory_pages)(initdata_prologue_size))
FC_REFLECT(upcx::chain::upcxvmoc::compilation_result_unknownfailure, )
FC_REFLECT(upcx::chain::upcxvmoc::compilation_result_toofull, )
FC_REFLECT(upcx::chain::upcxvmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes))
