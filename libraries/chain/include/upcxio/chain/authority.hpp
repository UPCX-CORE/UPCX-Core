...
FC_REFLECT(upcxio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(upcxio::chain::key_weight, (key)(weight) )
FC_REFLECT(upcxio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(upcxio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(upcxio::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(upcxio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(upcxio::chain::shared_public_key, (pubkey))
