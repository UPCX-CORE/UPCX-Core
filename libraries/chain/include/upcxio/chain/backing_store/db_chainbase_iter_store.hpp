...
class db_chainbase_iter_store {
   public:
      ...
      const table_id_object* find_table_by_end_iterator( int ei )const {
         UPCX_ASSERT( ei < -1, invalid_table_iterator, "not an end iterator" );
      ...
      const T& get( int iterator ) {
         UPCX_ASSERT( iterator != -1, invalid_table_iterator, "invalid iterator" );
         UPCX_ASSERT( iterator >= 0, table_operation_not_permitted, "dereference of end iterator" );
      ...
      void remove( int iterator ) {
         UPCX_ASSERT( iterator != -1, invalid_table_iterator, "invalid iterator" );
         UPCX_ASSERT( iterator >= 0, table_operation_not_permitted, "cannot call remove on end iterators" );
         UPCX_ASSERT( (size_t)iterator < _iterator_to_object.size(), invalid_table_iterator, "iterator out of range" );
