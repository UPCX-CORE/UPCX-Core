...
namespace backing_store {
      ...
      std::unique_ptr<db_context> create_db_rocksdb_context(apply_context& context, name receiver,
                                                            upcxio::session::session_variant<upcxio::session::session<upcxio::session::rocksdb_t>, upcxio::session::session<upcxio::session::session<upcxio::session::rocksdb_t>>> session);
