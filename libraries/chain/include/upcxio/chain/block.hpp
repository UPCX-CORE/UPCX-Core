#pragma once
#include <upcxio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( upcxio::chain::transaction_receipt_header::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )
FC_REFLECT_ENUM( upcxio::chain::signed_block::prune_state_type,
                 (incomplete)(complete)(complete_legacy) )

FC_REFLECT(upcxio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(upcxio::chain::transaction_receipt_v0, (upcxio::chain::transaction_receipt_header), (trx) )
FC_REFLECT(upcxio::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(upcxio::chain::signed_block_v0, (upcxio::chain::signed_block_header), (transactions)(block_extensions) )

FC_REFLECT_DERIVED(upcxio::chain::transaction_receipt, (upcxio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(upcxio::chain::signed_block, (upcxio::chain::signed_block_header), (prune_state)(transactions)(block_extensions) )
