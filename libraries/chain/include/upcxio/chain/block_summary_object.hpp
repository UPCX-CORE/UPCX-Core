...
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::block_summary_object, upcxio::chain::block_summary_multi_index)

FC_REFLECT( upcxio::chain::block_summary_object, (block_id) )
