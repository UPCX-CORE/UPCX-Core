...
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::code_object, upcxio::chain::code_index)

FC_REFLECT(upcxio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
