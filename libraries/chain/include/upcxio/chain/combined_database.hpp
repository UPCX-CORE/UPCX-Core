...
#include <upcxio/chain/block_state.hpp>
...
#include <upcxio/chain/backing_store.hpp>
...
#include <upcxio/chain/database_header_object.hpp>
#include <upcxio/chain/generated_transaction_object.hpp>
#include <upcxio/chain/genesis_intrinsics.hpp>
...
namespace upcxio { namespace chain {
   ...
   class combined_session {
    public:
      ...
      combined_session(chainbase::database& cb_database, upcxio::session::undo_stack<rocks_db_type>* undo_stack);
    ...
    private:
      ...
      upcxio::session::undo_stack<rocks_db_type>*     kv_undo_stack = nullptr;
   };
   ...
   class combined_database {
    public:
      ...
      void add_to_snapshot(const upcxio::chain::snapshot_writer_ptr& snapshot, const upcxio::chain::block_state& head,
      ...
      void read_from_snapshot(const snapshot_reader_ptr& snapshot, uint32_t blog_start, uint32_t blog_end,
                              ...
                              uint32_t& snapshot_head_block, const upcxio::chain::chain_id_type& chain_id);
   ...
   std::optional<upcxio::chain::genesis_state> extract_legacy_genesis_state(snapshot_reader& snapshot, uint32_t version);
