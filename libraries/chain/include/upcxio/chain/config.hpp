...
namespace upcxio { namespace chain { namespace config {
...
const static name system_account_name    { "upcxio"_n };
const static name null_account_name      { "upcxio.null"_n };
const static name producers_account_name { "upcxio.prods"_n };
...
const static name upcxio_auth_scope       { "upcxio.auth"_n };
const static name upcxio_all_scope        { "upcxio.all"_n };

const static name active_name     { "active"_n };
const static name owner_name      { "owner"_n };
const static name upcxio_any_name  { "upcxio.any"_n };
const static name upcxio_code_name { "upcxio.code"_n };
...
const static upcxio::chain::wasm_interface::vm_type default_wasm_runtime = upcxio::chain::wasm_interface::vm_type::upcx_vm_jit;
