...
#include <upcxio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::table_id_object, upcxio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::key_value_object, upcxio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(upcxio::chain::index64_object, upcxio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::index128_object, upcxio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::index256_object, upcxio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::index_double_object, upcxio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::index_long_double_object, upcxio::chain::index_long_double_index)

FC_REFLECT(upcxio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
// @ignore t_id
FC_REFLECT(upcxio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(upcxio::chain::index64_object)
REFLECT_SECONDARY(upcxio::chain::index128_object)
REFLECT_SECONDARY(upcxio::chain::index256_object)
REFLECT_SECONDARY(upcxio::chain::index_double_object)
REFLECT_SECONDARY(upcxio::chain::index_long_double_object)
