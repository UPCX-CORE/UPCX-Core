...
using action_name    = upcxio::chain::action_name;
...
FC_REFLECT( upcxio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( upcxio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( upcxio::chain::setabi                           , (account)(abi) )
FC_REFLECT( upcxio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( upcxio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( upcxio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( upcxio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( upcxio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( upcxio::chain::onerror                          , (sender_id)(sent_trx) )
