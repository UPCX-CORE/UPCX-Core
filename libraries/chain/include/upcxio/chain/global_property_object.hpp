...
#include <upcxio/chain/block_timestamp.hpp>
#include <upcxio/chain/chain_config.hpp>
#include <upcxio/chain/chain_snapshot.hpp>
#include <upcxio/chain/kv_config.hpp>
#include <upcxio/chain/wasm_config.hpp>
#include <upcxio/chain/producer_schedule.hpp>
#include <upcxio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::global_property_object, upcxio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::dynamic_global_property_object,
                         upcxio::chain::dynamic_global_property_multi_index)

FC_REFLECT(upcxio::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)(kv_configuration)(wasm_configuration)
          )

FC_REFLECT(upcxio::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(upcxio::chain::legacy::snapshot_global_property_object_v3,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(upcxio::chain::legacy::snapshot_global_property_object_v4,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)(kv_configuration)(wasm_configuration)
          )

FC_REFLECT(upcxio::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)(kv_configuration)(wasm_configuration)
          )

FC_REFLECT(upcxio::chain::dynamic_global_property_object,
