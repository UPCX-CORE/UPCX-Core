...
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::kv_db_config_object, upcxio::chain::kv_db_config_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::kv_object, upcxio::chain::kv_index)
FC_REFLECT(upcxio::chain::kv_db_config_object, (backing_store))
FC_REFLECT(upcxio::chain::kv_object_view, (contract)(kv_key)(kv_value)(payer))
FC_REFLECT(upcxio::chain::kv_object, (contract)(kv_key)(kv_value)(payer))
