...
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::permission_object, upcxio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::permission_usage_object, upcxio::chain::permission_usage_index)

FC_REFLECT(upcxio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(upcxio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(upcxio::chain::permission_usage_object, (last_used))
