...
FC_REFLECT( upcxio::chain::legacy::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( upcxio::chain::legacy::producer_schedule_type, (version)(producers) )
FC_REFLECT( upcxio::chain::block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( upcxio::chain::producer_authority, (producer_name)(authority) )
FC_REFLECT( upcxio::chain::producer_authority_schedule, (version)(producers) )
FC_REFLECT_DERIVED( upcxio::chain::producer_schedule_change_extension, (upcxio::chain::producer_authority_schedule), )

FC_REFLECT( upcxio::chain::shared_block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( upcxio::chain::shared_producer_authority, (producer_name)(authority) )
FC_REFLECT( upcxio::chain::shared_producer_authority_schedule, (version)(producers) )
