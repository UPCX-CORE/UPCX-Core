...
#include <upcxio/chain/action_receipt.hpp>
...
FC_REFLECT( upcxio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( upcxio::chain::action_trace,
...
// @ignore except_ptr
FC_REFLECT( upcxio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
