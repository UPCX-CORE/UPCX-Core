...
CHAINBASE_SET_INDEX_TYPE(upcxio::chain::transaction_object, upcxio::chain::transaction_multi_index)

FC_REFLECT(upcxio::chain::transaction_object, (expiration)(trx_id))
