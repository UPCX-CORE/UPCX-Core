...
namespace upcxio { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in UPCXIO code:
    *
    ...
    *  others are due to requirements to ensure determinism in the UPCXIO chain library.
    *
...
FC_REFLECT_EMPTY( upcxio::chain::void_t )
