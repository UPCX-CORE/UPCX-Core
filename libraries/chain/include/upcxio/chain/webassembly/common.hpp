...
#include <upcxio/vm/argument_proxy.hpp>
#include <upcxio/vm/span.hpp>
...
namespace upcxio { namespace chain {
   ...
   // define the type converter for upcxio
   struct type_converter : public upcxio::vm::type_converter<webassembly::interface, upcxio::vm::execution_interface> {
      using base_type = upcxio::vm::type_converter<webassembly::interface, upcxio::vm::execution_interface>;
