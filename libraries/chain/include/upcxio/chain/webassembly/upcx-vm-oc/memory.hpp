...
#include <upcxio/chain/webassembly/upcx-vm-oc/gs_seg_helpers.h>
...
class memory {
      ...
      static constexpr uint64_t mutable_global_size               = 8u  * upcxio::chain::wasm_constraints::maximum_mutable_globals/4u;
      static constexpr uint64_t table_size                        = 16u * upcxio::chain::wasm_constraints::maximum_table_elements;
