...
Removes the restriction on upcx::linkauth for non-native actions named one of the five special action names:
...
Forward upcx::setcode actions to the WebAssembly code deployed on the upcx account.
*/
            {}
         } )
