...
void validate_authority_precondition( const apply_context& context, const authority& auth ) {
   for(const auto& a : auth.accounts) {
      ...
      if( a.permission.permission == config::upcxio_code_name ) // virtual upcxio.code permission does not really exist but is allowed
         continue;
 ...
 */
void apply_upcxio_newaccount(apply_context& context) {
...
void apply_upcxio_setcode(apply_context& context) {
...
void apply_upcxio_setabi(apply_context& context) {
   auto& db  = context.db;
...
void apply_upcxio_updateauth(apply_context& context) {
...
void apply_upcxio_deleteauth(apply_context& context) {
//   context.require_write_lock( config::upcxio_auth_scope );
...
void apply_upcxio_linkauth(apply_context& context) {
//   context.require_write_lock( config::upcxio_auth_scope );
...
void apply_upcxio_unlinkauth(apply_context& context) {
//   context.require_write_lock( config::upcxio_auth_scope );
...
void apply_upcxio_canceldelay(apply_context& context) {
