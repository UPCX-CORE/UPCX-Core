...
namespace wasm_constraints = upcx::chain::wasm_constraints;
...
class upcx_vm_instantiated_module : public wasm_instantiated_module_interface {
   ...
   public:
      ...
      void apply(apply_context& context) override {
         ...
         auto fn = [&]() {
            upcx::chain::webassembly::interface iface(context);
         ...
         } catch(upcx::vm::timeout_exception&) {
            context.trx_context.checktime();
         } catch(upcx::vm::wasm_memory_exception& e) {
...
template class upcx_vm_runtime<upcx::vm::interpreter>;
template class upcx_vm_runtime<upcx::vm::jit>;
...
#ifdef UPCX_UPCX_VM_OC_RUNTIME_ENABLED
      constexpr bool is_injected = (Mod() == BOOST_HANA_STRING(UPCX_INJECTED_MODULE_NAME));
...
#define REGISTER_INJECTED_HOST_FUNCTION(NAME, ...)                                                                     \
   static host_function_registrator<&interface::NAME, ##__VA_ARGS__> NAME##_registrator_impl() {                       \
      return {BOOST_HANA_STRING(UPCX_INJECTED_MODULE_NAME), BOOST_HANA_STRING(#NAME)};                                \
   }                                                                                                                   \
...
// softfloat api
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_add);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_sub);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_div);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_mul);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_min);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_max);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_copysign);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_abs);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_neg);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_sqrt);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_ceil);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_floor);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_trunc);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_nearest);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_eq);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_ne);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_lt);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_le);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_gt);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_ge);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_add);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_sub);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_div);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_mul);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_min);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_max);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_copysign);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_abs);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_neg);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_sqrt);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_ceil);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_floor);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_trunc);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_nearest);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_eq);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_ne);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_lt);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_le);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_gt);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_ge);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_promote);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_demote);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_trunc_i32s);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_trunc_i32s);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_trunc_i32u);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_trunc_i32u);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_trunc_i64s);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_trunc_i64s);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f32_trunc_i64u);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_f64_trunc_i64u);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_i32_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_i64_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_ui32_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_ui64_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_i32_to_f64);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_i64_to_f64);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_ui32_to_f64);
REGISTER_INJECTED_HOST_FUNCTION(_upcx_ui64_to_f64);
...
REGISTER_LEGACY_CF_HOST_FUNCTION(upcx_assert)
REGISTER_LEGACY_CF_HOST_FUNCTION(upcx_assert_message)
REGISTER_CF_HOST_FUNCTION(upcx_assert_code)
REGISTER_CF_HOST_FUNCTION(upcx_exit)
