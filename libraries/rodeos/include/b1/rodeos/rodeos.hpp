...
struct rodeos_filter {
   ...
   rodeos_filter(upcxio::name name, const std::string& wasm_filename);

   void process(rodeos_db_snapshot& snapshot, const upcxio::ship_protocol::get_blocks_result_base& result,
