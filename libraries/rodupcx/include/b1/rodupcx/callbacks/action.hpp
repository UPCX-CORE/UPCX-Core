...
struct action_callbacks {
   ...
   int read_action_data(upcx::vm::span<char> data) {
   ...
   void set_action_return_value(upcx::vm::span<const char> packed_blob) {
      ...
      UPCX_ASSERT(packed_blob.size() <= max_action_return_value_size,
                 upcx::chain::action_return_value_exception, 
