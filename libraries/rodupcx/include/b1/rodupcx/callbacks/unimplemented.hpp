...
struct unimplemented_callbacks {
   ...
   uint32_t get_parameters_packed(upcxio::vm::span<const char>, upcxio::vm::span<char>) const { return unimplemented<uint32_t>("get_parameters_packed"); }
   void set_parameters_packed( upcxio::vm::span<const char> ) { return unimplemented<uint32_t>("set_parameters_packed"); }
...
#undef DB_SECONDARY_INDEX_METHODS_ARRAY
   ...
   void upcxio_assert_code(int, int64_t) { return unimplemented<void>("upcxio_assert_code"); }
   void upcxio_exit(int) { return unimplemented<void>("upcxio_exit"); }
...
#undef DB_SECONDARY_INDEX_METHODS_ARRAY
      ...
      // context_free_system_api
      Rft::template add<&Derived::upcxio_assert_code>("env", "upcxio_assert_code");
      Rft::template add<&Derived::upcxio_exit>("env", "upcxio_exit");
