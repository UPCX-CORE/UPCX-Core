...
// compile with upcxio-cpp -o hello.wasm hello.cpp
//#include <upcxio/upcxio.hpp>
//#include <upcxio/print.hpp>
//
// extern "C" {
//[[upcxio::wasm_import]] void print_name(const char*);
//[[upcxio::wasm_import]] void print_num(uint64_t);
//[[upcxio::wasm_import]] void print_span(const char*, std::size_t);
//
