...
// compile with upcx-cpp -o hello.wasm hello.cpp
//#include <upcx/upcx.hpp>
//#include <upcx/print.hpp>
//
// extern "C" {
//[[upcx::wasm_import]] void print_name(const char*);
//[[upcx::wasm_import]] void print_num(uint64_t);
//[[upcx::wasm_import]] void print_span(const char*, std::size_t);
//
