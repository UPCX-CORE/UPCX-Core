...
This file contains a list of community authored plugins for `nodupcx` and APIs/tools that are associated with plugins, acting as a directory of the community authored plugins that are available.
...
| MySQL                                                   | https://github.com/upcxBLACK/upcx_mysqldb_plugin                 |
| SQL                                                     | https://github.com/asiniscalchi/upcx_sql_plugin                  |
| Watch for specific actions and send them to an HTTP URL | https://github.com/upcxauthority/upcx-watcher-plugin             |
| ZMQ / history                                           | https://github.com/cc32d9/upcx_zmq_plugin                        |
| ZMQ Light History API                                   | https://github.com/cc32d9/upcx_zmq_light_api                     |
...
| Hyperion History API                                    | https://github.com/upcxrio/Hyperion-History-API                  |
