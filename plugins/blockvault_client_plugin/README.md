...
```
nodeos --plugin upcxio::producer_plugin --producer-name myproducera --plugin upcxio::blockvault_client_plugin --block-vault-backend postgresql://user:password@mycompany.com
```
...
nodeos --plugin upcxio::producer_plugin --producer-name myproducera --plugin upcxio::blockvault_client_plugin --block-vault-backend postgresql://user@mycompany.com
```
