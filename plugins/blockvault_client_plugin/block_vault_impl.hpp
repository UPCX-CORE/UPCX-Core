...
struct transform_callback : backend::sync_callback {
   ...
   upcx::blockvault::sync_callback& target;

   transform_callback(Compressor& comp, upcx::blockvault::sync_callback& t)
       : compressor(comp)
       , target(t) {}
...
class block_vault_impl : public block_vault_interface {
 ...
 public:
   ...
   void async_propose_constructed_block(uint32_t lib, chain::signed_block_ptr block,
      ...
      boost::asio::post(ioc, [this, handler, lib, block]() {
         try {
            ...
            upcx::chain::block_id_type block_id = block->calculate_id();
   ...
   void sync(const upcx::chain::block_id_type* ptr_block_id, sync_callback& callback) override {
