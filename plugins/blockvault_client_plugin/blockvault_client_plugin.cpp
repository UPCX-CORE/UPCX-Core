...
#include <upcxio/blockvault_client_plugin/blockvault_client_plugin.hpp> // upcxio::blockvault_client_plugin
...
using vault_impl = upcxio::blockvault::block_vault_impl<upcxio::blockvault::zlib_compressor>;
...
upcxio::blockvault::block_vault_interface* blockvault_client_plugin::get() { return my.get(); }
