...
#include <upcx/blockvault_client_plugin/blockvault_client_plugin.hpp> // upcx::blockvault_client_plugin
...
using vault_impl = upcx::blockvault::block_vault_impl<upcx::blockvault::zlib_compressor>;
...
upcx::blockvault::block_vault_interface* blockvault_client_plugin::get() { return my.get(); }
