...
template <>
struct backend_reset<upcxio::blockvault::postgres_backend> {
   backend_reset() {
...
struct backend_test_fixture : backend_reset<Backend> {
   ...
   void sync(std::optional<mock_block_id> previous_block_id, upcxio::blockvault::backend::sync_callback& callback) {
...
typedef boost::mpl::list<upcxio::blockvault::postgres_backend> test_types;
...
struct mock_sync_callback : upcxio::blockvault::backend::sync_callback {
