...
public:
   ...
   upcx::chain::backing_store_type get_backing_store() const;
   ...
   void walk_key_value_table(const name& code, const name& scope, const name& table, Function f) const
   {
      ...
      if (db_backing_store == upcx::chain::backing_store_type::CHAINBASE) {
         ...
         auto end = start.next();
         upcx::chain::backing_store::walk_rocksdb_entries_with_prefix(kv_database.get_kv_undo_stack(), start, end, writer);
      }
   }
   ...
   read_only::get_table_rows_result get_table_rows_by_seckey( const read_only::get_table_rows_params& p, const abi_def& abi, ConvFn conv )const {
      ...
      auto secondary_key_lower = upcx::chain::secondary_key_traits<secondary_key_type>::true_lowest();
      const auto primary_key_lower = std::numeric_limits<uint64_t>::lowest();
      auto secondary_key_upper = upcx::chain::secondary_key_traits<secondary_key_type>::true_highest();
      ...
      if( p.lower_bound.size() ) {
         if( p.key_type == "name" ) {
            if constexpr (std::is_same_v<uint64_t, SecKeyType>) {
               ...
               UPCX_ASSERT(false, chain::contract_table_query_exception, "Invalid key type of upcx::name ${nm} for lower bound", ("nm", p.lower_bound));
            }
         } else {
      ...
      if( p.upper_bound.size() ) {
         if( p.key_type == "name" ) {
            if constexpr (std::is_same_v<uint64_t, SecKeyType>) {
               ...
               UPCX_ASSERT(false, chain::contract_table_query_exception, "Invalid key type of upcx::name ${nm} for upper bound", ("nm", p.upper_bound));
            }
         } else {
...
FC_REFLECT( upcx::chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT(upcx::chain_apis::empty, )
FC_REFLECT(upcx::chain_apis::read_only::get_info_results,
...
FC_REFLECT(upcx::chain_apis::read_only::get_activated_protocol_features_params, (lower_bound)(upper_bound)(limit)(search_by_block_num)(reverse) )
FC_REFLECT(upcx::chain_apis::read_only::get_activated_protocol_features_results, (activated_protocol_features)(more) )
FC_REFLECT(upcx::chain_apis::read_only::get_block_params, (block_num_or_id))
FC_REFLECT(upcx::chain_apis::read_only::get_block_info_params, (block_num))
FC_REFLECT(upcx::chain_apis::read_only::get_block_header_state_params, (block_num_or_id))

FC_REFLECT( upcx::chain_apis::read_write::push_transaction_results, (transaction_id)(processed) )

FC_REFLECT( upcx::chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit)(key_type)(index_position)(encode_type)(reverse)(show_payer) )
FC_REFLECT( upcx::chain_apis::read_only::get_kv_table_rows_params, (json)(code)(table)(index_name)(encode_type)(index_value)(lower_bound)(upper_bound)(limit)(reverse)(show_payer) )
FC_REFLECT( upcx::chain_apis::read_only::get_table_rows_result, (rows)(more)(next_key)(next_key_bytes) );

FC_REFLECT( upcx::chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit)(reverse) )
FC_REFLECT( upcx::chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
FC_REFLECT( upcx::chain_apis::read_only::get_table_by_scope_result, (rows)(more) );

FC_REFLECT( upcx::chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
FC_REFLECT( upcx::chain_apis::read_only::get_currency_stats_params, (code)(symbol));
FC_REFLECT( upcx::chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));

FC_REFLECT( upcx::chain_apis::read_only::get_producers_params, (json)(lower_bound)(limit) )
FC_REFLECT( upcx::chain_apis::read_only::get_producers_result, (rows)(total_producer_vote_weight)(more) );

FC_REFLECT_EMPTY( upcx::chain_apis::read_only::get_producer_schedule_params )
FC_REFLECT( upcx::chain_apis::read_only::get_producer_schedule_result, (active)(pending)(proposed) );

FC_REFLECT( upcx::chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
FC_REFLECT( upcx::chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );
...
FC_REFLECT( upcx::chain_apis::read_only::get_raw_code_and_abi_params, (account_name) )
FC_REFLECT( upcx::chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi) )
FC_REFLECT( upcx::chain_apis::read_only::get_raw_abi_params, (account_name)(abi_hash) )
FC_REFLECT( upcx::chain_apis::read_only::get_raw_abi_results, (account_name)(code_hash)(abi_hash)(abi) )
FC_REFLECT( upcx::chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( upcx::chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
FC_REFLECT( upcx::chain_apis::read_only::abi_json_to_bin_result, (binargs) )
FC_REFLECT( upcx::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
FC_REFLECT( upcx::chain_apis::read_only::abi_bin_to_json_result, (args) )
FC_REFLECT( upcx::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
FC_REFLECT( upcx::chain_apis::read_only::get_required_keys_result, (required_keys) )
