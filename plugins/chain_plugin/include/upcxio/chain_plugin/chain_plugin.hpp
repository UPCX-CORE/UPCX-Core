...
#include <upcxio/chain/transaction.hpp>
#include <upcxio/chain/abi_serializer.hpp>
#include <upcxio/chain/plugin_interface.hpp>
#include <upcxio/chain/types.hpp>
#include <upcxio/chain/types.hpp>
#include <upcxio/chain/fixed_bytes.hpp>
...
#include <upcxio/chain_plugin/account_query_db.hpp>
...
public:
   ...
   upcxio::chain::backing_store_type get_backing_store() const;
   ...
   bool get_primary_key_internal(name code, name scope, name table, uint64_t primary_key, row_requirements require_table,
      ...
      if (db_backing_store == upcxio::chain::backing_store_type::CHAINBASE) {
         ...
         UPCX_ASSERT(table_id, chain::contract_table_query_exception,
         ...
         UPCX_ASSERT(it != kv_index.end(), chain::contract_table_query_exception,
         ...
         if (!value) {
            ...
            if (require_table == row_requirements::required) {
               ...
               UPCX_ASSERT(value, chain::contract_table_query_exception,
                          "Missing code: ${code}, scope: ${scope}, table: ${table}",
                          ("code",code.to_string())("scope",scope.to_string())("table",table.to_string()));
            }
            UPCX_ASSERT(require_primary == row_requirements::optional, chain::contract_table_query_exception,
                       "Missing row for primary_key: ${primary} in code: ${code}, scope: ${scope}, table: ${table}",
                       ("primary", primary_key)("code",code.to_string())("scope",scope.to_string())
                       ("table",table.to_string()));
            return false;
   ...
   void walk_key_value_table(const name& code, const name& scope, const name& table, Function f) const
   {
      ...
      if (db_backing_store == upcxio::chain::backing_store_type::CHAINBASE) {
         ...
         auto end = start.next();
         upcxio::chain::backing_store::walk_rocksdb_entries_with_prefix(kv_database.get_kv_undo_stack(), start, end, writer);
      }
   }
   ...
   read_only::get_table_rows_result get_table_rows_by_seckey( const read_only::get_table_rows_params& p, const abi_def& abi, ConvFn conv )const {
      ...
      auto secondary_key_lower = upcxio::chain::secondary_key_traits<secondary_key_type>::true_lowest();
      const auto primary_key_lower = std::numeric_limits<uint64_t>::lowest();
      auto secondary_key_upper = upcxio::chain::secondary_key_traits<secondary_key_type>::true_highest();
      ...
      if( p.lower_bound.size() ) {
         if( p.key_type == "name" ) {
            if constexpr (std::is_same_v<uint64_t, SecKeyType>) {
               ...
               UPCX_ASSERT(false, chain::contract_table_query_exception, "Invalid key type of upcxio::name ${nm} for lower bound", ("nm", p.lower_bound));
            }
         } else {
      ...
      if( p.upper_bound.size() ) {
         if( p.key_type == "name" ) {
            if constexpr (std::is_same_v<uint64_t, SecKeyType>) {
               ...
               UPCX_ASSERT(false, chain::contract_table_query_exception, "Invalid key type of upcxio::name ${nm} for upper bound", ("nm", p.upper_bound));
            }
         } else {
...
FC_REFLECT( upcxio::chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT(upcxio::chain_apis::empty, )
FC_REFLECT(upcxio::chain_apis::read_only::get_info_results,
...
FC_REFLECT(upcxio::chain_apis::read_only::get_activated_protocol_features_params, (lower_bound)(upper_bound)(limit)(search_by_block_num)(reverse) )
FC_REFLECT(upcxio::chain_apis::read_only::get_activated_protocol_features_results, (activated_protocol_features)(more) )
FC_REFLECT(upcxio::chain_apis::read_only::get_block_params, (block_num_or_id))
FC_REFLECT(upcxio::chain_apis::read_only::get_block_info_params, (block_num))
FC_REFLECT(upcxio::chain_apis::read_only::get_block_header_state_params, (block_num_or_id))

FC_REFLECT( upcxio::chain_apis::read_write::push_transaction_results, (transaction_id)(processed) )

FC_REFLECT( upcxio::chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit)(key_type)(index_position)(encode_type)(reverse)(show_payer) )
FC_REFLECT( upcxio::chain_apis::read_only::get_kv_table_rows_params, (json)(code)(table)(index_name)(encode_type)(index_value)(lower_bound)(upper_bound)(limit)(reverse)(show_payer) )
FC_REFLECT( upcxio::chain_apis::read_only::get_table_rows_result, (rows)(more)(next_key)(next_key_bytes) );

FC_REFLECT( upcxio::chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit)(reverse) )
FC_REFLECT( upcxio::chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
FC_REFLECT( upcxio::chain_apis::read_only::get_table_by_scope_result, (rows)(more) );

FC_REFLECT( upcxio::chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
FC_REFLECT( upcxio::chain_apis::read_only::get_currency_stats_params, (code)(symbol));
FC_REFLECT( upcxio::chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));

FC_REFLECT( upcxio::chain_apis::read_only::get_producers_params, (json)(lower_bound)(limit) )
FC_REFLECT( upcxio::chain_apis::read_only::get_producers_result, (rows)(total_producer_vote_weight)(more) );

FC_REFLECT_EMPTY( upcxio::chain_apis::read_only::get_producer_schedule_params )
FC_REFLECT( upcxio::chain_apis::read_only::get_producer_schedule_result, (active)(pending)(proposed) );

FC_REFLECT( upcxio::chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
FC_REFLECT( upcxio::chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );

FC_REFLECT( upcxio::chain_apis::read_only::account_resource_info, (used)(available)(max)(last_usage_update_time)(current_used) )
FC_REFLECT( upcxio::chain_apis::read_only::get_account_results,
            (account_name)(head_block_num)(head_block_time)(privileged)(last_code_update)(created)
            (core_liquid_balance)(ram_quota)(net_weight)(cpu_weight)(net_limit)(cpu_limit)(ram_usage)(permissions)
            (total_resources)(self_delegated_bandwidth)(refund_request)(voter_info)(rex_info) )
// @swap code_hash
FC_REFLECT( upcxio::chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(wasm)(abi) )
FC_REFLECT( upcxio::chain_apis::read_only::get_code_hash_results, (account_name)(code_hash) )
FC_REFLECT( upcxio::chain_apis::read_only::get_abi_results, (account_name)(abi) )
FC_REFLECT( upcxio::chain_apis::read_only::get_account_params, (account_name)(expected_core_symbol) )
FC_REFLECT( upcxio::chain_apis::read_only::get_code_params, (account_name)(code_as_wasm) )
FC_REFLECT( upcxio::chain_apis::read_only::get_code_hash_params, (account_name) )
FC_REFLECT( upcxio::chain_apis::read_only::get_abi_params, (account_name) )
FC_REFLECT( upcxio::chain_apis::read_only::get_raw_code_and_abi_params, (account_name) )
FC_REFLECT( upcxio::chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi) )
FC_REFLECT( upcxio::chain_apis::read_only::get_raw_abi_params, (account_name)(abi_hash) )
FC_REFLECT( upcxio::chain_apis::read_only::get_raw_abi_results, (account_name)(code_hash)(abi_hash)(abi) )
FC_REFLECT( upcxio::chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( upcxio::chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
FC_REFLECT( upcxio::chain_apis::read_only::abi_json_to_bin_result, (binargs) )
FC_REFLECT( upcxio::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
FC_REFLECT( upcxio::chain_apis::read_only::abi_bin_to_json_result, (args) )
FC_REFLECT( upcxio::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
FC_REFLECT( upcxio::chain_apis::read_only::get_required_keys_result, (required_keys) )
