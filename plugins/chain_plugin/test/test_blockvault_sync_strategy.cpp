...
using namespace upcx::blockvault;
...
struct mock_blockvault_t : public block_vault_interface {
   upcx::chain::block_id_type _previous_block_id{};
   ...
   virtual void sync(const upcx::chain::block_id_type* previous_block_id, sync_callback& callback) override {
