...
public:
    ...
    transaction_trace_ptr create_account_with_resources( account_name a, account_name creator, asset ramfunds, bool multisig,
...

      {
         ...
         owner_auth.accounts.push_back( permission_level_weight{ {a, config::upcx_code_name},
                                                                 static_cast<weight_type>(owner_auth.threshold) } );
         sort_permissions(owner_auth);
         active_auth.accounts.push_back( permission_level_weight{ {a, config::upcx_code_name},
    ...
    void setup_system_accounts(){
       create_accounts({ "upcx.token"_n, "upcx.ram"_n, "upcx.ramfee"_n, "upcx.stake"_n,
                         "upcx.bpay"_n, "upcx.vpay"_n, "upcx.saving"_n, "upcx.names"_n, "upcx.rex"_n });
       ...
       BOOST_CHECK_EQUAL( core_from_string("1000000000.0000"), get_balance( name("upcx") ) );
