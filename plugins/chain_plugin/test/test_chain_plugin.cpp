...
using namespace upcxio::chain_apis;
...
public:
    ...
    transaction_trace_ptr create_account_with_resources( account_name a, account_name creator, asset ramfunds, bool multisig,
...

      {
         ...
         owner_auth.accounts.push_back( permission_level_weight{ {a, config::upcxio_code_name},
                                                                 static_cast<weight_type>(owner_auth.threshold) } );
         sort_permissions(owner_auth);
         active_auth.accounts.push_back( permission_level_weight{ {a, config::upcxio_code_name},
    ...
    void setup_system_accounts(){
       create_accounts({ "upcxio.token"_n, "upcxio.ram"_n, "upcxio.ramfee"_n, "upcxio.stake"_n,
                         "upcxio.bpay"_n, "upcxio.vpay"_n, "upcxio.saving"_n, "upcxio.names"_n, "upcxio.rex"_n });
       ...
       BOOST_CHECK_EQUAL( core_from_string("1000000000.0000"), get_balance( name("upcxio") ) );
