#include <upcx/history_plugin/history_plugin.hpp>
#include <upcx/history_plugin/account_control_history_object.hpp>
#include <upcx/history_plugin/public_key_history_object.hpp>
...
CHAINBASE_SET_INDEX_TYPE(upcx::account_history_object, upcx::account_history_index)
CHAINBASE_SET_INDEX_TYPE(upcx::action_history_object, upcx::action_history_index)
      ...
      try {
         if( options.count( "filter-on" )) {
            ...
            for( auto& s : fo ) {
               ...
               filter_entry fe{upcx::chain::name(v[0]), upcx::chain::name(v[1]), upcx::chain::name(v[2])};
