...
CHAINBASE_SET_INDEX_TYPE( upcx::account_control_history_object, upcx::account_control_history_multi_index )

FC_REFLECT( upcx::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
