...
FC_REFLECT( upcx::history_apis::read_only::get_actions_params, (account_name)(pos)(offset) )
FC_REFLECT( upcx::history_apis::read_only::get_actions_result, (actions)(last_irreversible_block)(time_limit_exceeded_error) )
FC_REFLECT( upcx::history_apis::read_only::ordered_action_result, (global_action_seq)(account_action_seq)(block_num)(block_time)(action_trace) )
...
FC_REFLECT(upcx::history_apis::read_only::get_controlled_accounts_results, (controlled_accounts) )
