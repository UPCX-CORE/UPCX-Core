...
CHAINBASE_SET_INDEX_TYPE( upcx::public_key_history_object, upcx::public_key_history_multi_index )

FC_REFLECT( upcx::public_key_history_object, (public_key)(name)(permission) )
