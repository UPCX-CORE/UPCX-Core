...
CHAINBASE_SET_INDEX_TYPE( upcxio::account_control_history_object, upcxio::account_control_history_multi_index )

FC_REFLECT( upcxio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
