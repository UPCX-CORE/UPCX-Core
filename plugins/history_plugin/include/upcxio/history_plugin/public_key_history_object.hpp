...
CHAINBASE_SET_INDEX_TYPE( upcxio::public_key_history_object, upcxio::public_key_history_multi_index )

FC_REFLECT( upcxio::public_key_history_object, (public_key)(name)(permission) )
