...
#include <upcx/net_plugin/protocol.hpp>
...
namespace upcx {
   ...
   using upcx::chain::transaction_id_type;
   using upcx::chain::sha256_less;
   ...
   typedef multi_index_container<
      upcx::peer_block_state,
      indexed_by<
         ordered_unique< tag<by_id>,
               composite_key< peer_block_state,
                     member<peer_block_state, uint32_t, &upcx::peer_block_state::connection_id>,
                     member<peer_block_state, block_id_type, &upcx::peer_block_state::id>
               >,
         ...
         ordered_non_unique< tag<by_peer_block_id>,
               composite_key< peer_block_state,
                     member<peer_block_state, block_id_type, &upcx::peer_block_state::id>,
                     member<peer_block_state, bool, &upcx::peer_block_state::have_block>
               >,
               composite_key_compare< sha256_less, std::greater<bool> >
         >,
         ordered_non_unique< tag<by_block_num>, member<upcx::peer_block_state, uint32_t, &upcx::peer_block_state::block_num > >
      >
   ...
   public:
      ...
      std::optional<upcx::chain::named_thread_pool> thread_pool;
...
#define peer_elog( PEER, FORMAT, ... ) \
  ...
  FC_MULTILINE_MACRO_END
   ...
   constexpr uint16_t proto_explicit_sync = 1;       // version at time of upcx 1.0
