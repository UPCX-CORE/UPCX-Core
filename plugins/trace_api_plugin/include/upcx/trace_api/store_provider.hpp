...
#include <upcx/trace_api/common.hpp>
#include <upcx/trace_api/metadata_log.hpp>
#include <upcx/trace_api/data_log.hpp>
#include <upcx/trace_api/compressed_file.hpp>

namespace upcx::trace_api {
...
FC_REFLECT(upcx::trace_api::slice_directory::index_header, (version))
