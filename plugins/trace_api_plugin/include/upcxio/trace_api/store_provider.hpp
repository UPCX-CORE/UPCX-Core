...
#include <upcxio/trace_api/common.hpp>
#include <upcxio/trace_api/metadata_log.hpp>
#include <upcxio/trace_api/data_log.hpp>
#include <upcxio/trace_api/compressed_file.hpp>

namespace upcxio::trace_api {
...
FC_REFLECT(upcxio::trace_api::slice_directory::index_header, (version))
