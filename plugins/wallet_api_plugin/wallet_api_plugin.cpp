...
FC_REFLECT(upcxio::detail::wallet_api_plugin_empty, );
...
#define INVOKE_R_R_R(api_handle, call_name, in_param0, in_param1) \
     ...
     if (params.size() != 2) { \
        UPCX_THROW(chain::invalid_http_request, "Missing valid input from POST body"); \
     } \
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     upcxio::detail::wallet_api_plugin_empty result;
