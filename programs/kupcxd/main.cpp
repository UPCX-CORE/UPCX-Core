...
#include <upcx/wallet_plugin/wallet_plugin.hpp>
#include <upcx/wallet_api_plugin/wallet_api_plugin.hpp>
...
int main(int argc, char** argv)
{
   try {
      ...
      app().set_default_data_dir(home / "upcx-wallet");
      app().set_default_config_dir(home / "upcx-wallet");
