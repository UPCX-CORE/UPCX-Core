...
struct report_time {
    ...
    void report() {
        ...
        ilog("upcx-blocklog - ${desc} took ${t} msec", ("desc", _desc)("t", duration));
    }
...
int prune_transactions(bfs::path block_dir, bfs::path state_history_dir, uint32_t block_num,
   ...
   using upcx::state_history_traces_log;
...
int main(int argc, char** argv) {
   ...
   options_description cli ("upcx-blocklog command line options");
   try {
      blocklog blog;
