...
mkdir -p ${PROJECT}/${VERSION}/opt/upcxio/lib/cmake
...
echo "class Upcxio < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/upcxio/upcx/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/upcxio/upcx/releases/download/v${VERSION}\"
