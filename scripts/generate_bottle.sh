...
mkdir -p ${PROJECT}/${VERSION}/opt/upcx/lib/cmake
...
echo "class Upcx < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/upcx/upcx/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/upcx/upcx/releases/download/v${VERSION}\"
