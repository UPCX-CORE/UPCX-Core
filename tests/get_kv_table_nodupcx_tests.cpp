...
BOOST_AUTO_TEST_SUITE(get_kv_table_nodupcx_tests)

using namespace upcxio::chain;
using namespace upcxio::testing;
using namespace fc;

BOOST_FIXTURE_TEST_CASE( get_kv_table_nodupcx_test, TESTER ) try {

   upcxio::chain_apis::read_only::get_table_rows_result result;
   ...
   push_action("upcxio"_n, "ramkvlimits"_n, "upcxio"_n, mutable_variant_object()("k", 1024)("v", 1024)("i", 1024));
   produce_blocks(1);
   ...
   // primarykey
   //////////////////////////////
   upcxio::chain_apis::read_only plugin(*(this->control), {}, fc::microseconds::maximum());
   upcxio::chain_apis::read_only::get_kv_table_rows_params p;
   p.code = "kvtable"_n;
   p.table = "kvtable"_n;
