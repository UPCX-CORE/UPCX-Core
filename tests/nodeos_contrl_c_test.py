...
try:
    ...
    specificExtraNodeosArgs[0] = "--plugin upcxio::producer_plugin --plugin upcxio::chain_api_plugin --plugin upcxio::http_plugin "
    "--plugin upcxio::txn_test_gen_plugin --plugin upcxio::producer_api_plugin "
    # producer nodes will be mapped to 0 through totalProducerNodes-1, so the number totalProducerNodes will be the non-producing node
    specificExtraNodeosArgs[totalProducerNodes] = "--plugin upcxio::producer_plugin --plugin upcxio::chain_api_plugin --plugin upcxio::http_plugin "
    "--plugin upcxio::txn_test_gen_plugin --plugin upcxio::producer_api_plugin "
