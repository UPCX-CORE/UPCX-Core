...
try:
    ...
    wallet=walletMgr.create(walletName, [cluster.upcxAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    ...
    upcxAccount=cluster.upcxAccount
    ...
    if not cluster.createAccounts(upcxAccount):
