...
try:
    ...
    wallet=walletMgr.create(walletName, [cluster.upcxioAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    ...
    upcxioAccount=cluster.upcxioAccount
    ...
    if not cluster.createAccounts(upcxioAccount):
