...
try:
    ...
    specificExtraNodupcxArgs[shipNodeNum]="--plugin upcxio::state_history_plugin --disable-replay-opts --sync-fetch-span 200 --plugin upcxio::net_api_plugin "
    ...
    Print("Shutdown state_history_plugin nodupcx")
