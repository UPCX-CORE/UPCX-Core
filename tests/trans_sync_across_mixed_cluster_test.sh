...
echo Launcher options: --nodeos \"--plugin upcxio::wallet_api_plugin\" $launcherOpts
programs/upcxio-launcher/upcxio-launcher --nodeos "--plugin upcxio::wallet_api_plugin" $launcherOpts
sleep 7
