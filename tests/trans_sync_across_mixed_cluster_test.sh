...
killAll()
{
  programs/upcx-launcher/upcx-launcher -k 15
}

cleanup()
{
    rm -rf etc/upcx/node_*
    rm -rf var/lib/node_*
}
...
echo Launcher options: --nodupcx \"--plugin upcx::wallet_api_plugin\" $launcherOpts
programs/upcx-launcher/upcx-launcher --nodupcx "--plugin upcx::wallet_api_plugin" $launcherOpts
sleep 7
