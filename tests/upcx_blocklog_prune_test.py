...
###############################################################
# upcx_blocklog_prune_test.py
#
# Test upcx-blocklog prune-transaction 
# 
...
# Afterwards, it uses upcx-blocklog to prune the transaction with context free
...
try:
    ...
    assert cluster.launch(
        ...
        specificExtraNodupcxArgs={
            0: "--plugin upcx::state_history_plugin --trace-history --disable-replay-opts --sync-fetch-span 200 --state-history-endpoint 127.0.0.1:8080 --plugin upcx::net_api_plugin --enable-stale-production",
