...
fastUnstakeSystem = './fast.refund/upcxio.system/upcxio.system.wasm'
...
def startNode(nodeIndex, account):
    ...
    cmd = (
        ...
        '    --plugin upcxio::producer_api_plugin'
...
def stepSetSystemContract():
    ...
    # activate PREACTIVATE_FEATURE before installing upcxio.boot
    retry('curl -X POST http://127.0.0.1:%d' % args.http_port + 
        '/v1/producer/schedule_protocol_feature_activations ' +
        '-d \'{"protocol_features_to_activate": ["0ec7e080177b2c02b278d5088611686b49d739925a92d9bfcacd7fc6b74053bd"]}\'')
    sleep(3)

    # install upcxio.boot which supports the native actions and activate 
...
def stepLog():
    run('tail -n 60 ' + args.nodes_dir + '00-upcxio/stderr')
...
commands = [
    ...
    ('q', 'resign',             stepResign,                 True,    "Resign upcxio"),
    ('m', 'msg-replace',        msigReplaceSystem,          False,   "Replace system contract using msig"),
    ('X', 'xfer',               stepTransfer,               False,   "Random transfer tokens (infinite loop)"),
    ('l', 'log',                stepLog,                    True,    "Show tail of node's log"),
]

parser.add_argument('--public-key', metavar='', help="UPCXIO Public Key", default='EOS8Znrtgwt8TfpmbVpTKvA2oB8Nqey625CLN8bCN3TEbgx86Dsvr', dest="public_key")
...
parser.add_argument('--symbol', metavar='', help="The upcxio.system symbol", default='SYS')
