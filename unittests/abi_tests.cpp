...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> std::optional<abi_serializer> {
      return abi_serializer(upcx_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
   };
}
...
{ try {
   ...
   abi_serializer abis(upcx_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   auto abi = upcx_contract_abi(fc::json::from_string(my_abi).as<abi_def>());
...
{ try {
   ...
   auto abi = upcx_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
...
{ try {
   ...
   abi_serializer abis(upcx_contract_abi(abi_def()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   abi_serializer abis(upcx_contract_abi(v.as<abi_def>()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   // testtable1_INVALID_NAME is not a valid upcx::name
...
{ try {
   ...
   auto abi = upcx_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
...
BOOST_AUTO_TEST_CASE(abi_account_name_in_upcx_abi)
{ try {
   // inifinite loop in types
   const char* repeat_abi = R"=====(
   {
...
BOOST_AUTO_TEST_CASE(abi_large_array)
{
   try {
      ...
      // curl http://127.0.0.1:8888/v1/chain/abi_bin_to_json -X POST -d '{"code":"upcx", "action":"hi", "binargs":"ffffffff08"}'
...
{
   using upcx::testing::fc_exception_message_starts_with;
...
BOOST_AUTO_TEST_CASE(version)
{
   try {
      ...
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({"version": "upcx::abi/9.0"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time )), unsupported_abi_version_exception );
      abi_serializer(fc::json::from_string(R"({"version": "upcx::abi/1.0"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
      abi_serializer(fc::json::from_string(R"({"version": "upcx::abi/1.1"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
      abi_serializer(fc::json::from_string(R"({"version": "upcx::abi/1.2"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
   } FC_LOG_AND_RETHROW()
}
...
{
   using upcx::testing::fc_exception_message_is;
...
inline std::pair<action_trace, std::string> generate_action_trace(const std::optional<T> &  return_value, const std::string &  return_value_hex, bool parsable = true)
{
   ...
   at.act = upcx::chain::action(
      std::vector<upcx::chain::permission_level>{
         upcx::chain::permission_level{
...
BOOST_AUTO_TEST_CASE(abi_to_variant__add_action__good_return_value)
{
   ...
   upcx::chain::impl::abi_traverse_context ctx(abi_serializer::create_yield_function(max_serialization_time));
   upcx::chain::impl::abi_to_variant::add(mvo, "action_traces", at, get_resolver(abidef), ctx);
...
BOOST_AUTO_TEST_CASE(transaction_extensions_tests)
{
   ...
   upcx::chain::impl::abi_traverse_context ctx(abi_serializer::create_yield_function(max_serialization_time));
   auto abi = upcx_contract_abi(fc::json::from_string(my_abi).as<abi_def>());
   upcx::chain::impl::abi_to_variant::add(mvo, "test", txn, get_resolver(abi), ctx);
   ...
   upcx::chain::impl::abi_to_variant::add(mvo2, "test", txn_clone, get_resolver(abi), ctx);
   ...
   upcx::chain::impl::abi_to_variant::add(mvo3, "test", txn_clone2, get_resolver(abi), ctx);
