...
struct act_sig {
   upcxio::chain::signature_type sig;
...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> std::optional<abi_serializer> {
      return abi_serializer(upcxio_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
   };
}
...
{ try {
   ...
   abi_serializer abis(upcxio_contract_abi(abi), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   auto abi = upcxio_contract_abi(fc::json::from_string(my_abi).as<abi_def>());

   abi_serializer abis(abi, abi_serializer::create_yield_function( max_serialization_time ));

   const char *my_other = R"=====(
    {
      "publickey"     :  "UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.0000 SYS",
      ...
      "keyweight": {"key":"UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "keyweight_arr": [{"key":"UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":100},{"key":"UPCX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":200}],
...
{ try {
   ...
   auto abi = upcxio_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
...
{ try {
   ...
   abi_serializer abis(upcxio_contract_abi(abi_def()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "auth" : {
        ...
        "keys" : [ {"key" : "UPCX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "UPCX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("UPCX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == updauth.auth.keys[0].key.to_string());
   BOOST_TEST(57005u == updauth.auth.keys[0].weight);
   BOOST_TEST("UPCX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == updauth.auth.keys[1].key.to_string());
...
{ try {
   ...
   BOOST_TEST("UPCX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == newacct.owner.keys[0].key.to_string());
   BOOST_TEST(57005u == newacct.owner.keys[0].weight);
   BOOST_TEST("UPCX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == newacct.owner.keys[1].key.to_string());
   ...
   BOOST_TEST("UPCX65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == newacct.active.keys[0].key.to_string());
   BOOST_TEST(57005u == newacct.active.keys[0].weight);
   BOOST_TEST("UPCX5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == newacct.active.keys[1].key.to_string());
...
{ try {
   ...
   abi_serializer abis(upcxio_contract_abi(v.as<abi_def>()), abi_serializer::create_yield_function( max_serialization_time ));
...
{ try {
   ...
   const char* abi_def_abi = R"=====(
   {
    "____comment": "This file was generated with upcxio-abigen. DO NOT EDIT ",
    "version": "upcxio::abi/1.2",
    "types": [],
    "structs": [],
    "actions": [],
    "tables": [],
   ...
   // testtable1_INVALID_NAME is not a valid upcxio::name
...
{ try {
   ...
   auto abi = upcxio_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
...
BOOST_AUTO_TEST_CASE(abi_account_name_in_upcxio_abi)
{ try {
   // inifinite loop in types
   const char* repeat_abi = R"=====(
   {
...
BOOST_AUTO_TEST_CASE(abi_large_array)
{
   try {
      ...
      // curl http://127.0.0.1:8888/v1/chain/abi_bin_to_json -X POST -d '{"code":"upcxio", "action":"hi", "binargs":"ffffffff08"}'
...
{
   using upcxio::testing::fc_exception_message_starts_with;
...
BOOST_AUTO_TEST_CASE(version)
{
   try {
      ...
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({"version": "upcxio::abi/9.0"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time )), unsupported_abi_version_exception );
      abi_serializer(fc::json::from_string(R"({"version": "upcxio::abi/1.0"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
      abi_serializer(fc::json::from_string(R"({"version": "upcxio::abi/1.1"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
      abi_serializer(fc::json::from_string(R"({"version": "upcxio::abi/1.2"})").as<abi_def>(), abi_serializer::create_yield_function( max_serialization_time ));
   } FC_LOG_AND_RETHROW()
}
...
{
   using upcxio::testing::fc_exception_message_is;
...
inline std::pair<action_trace, std::string> generate_action_trace(const std::optional<T> &  return_value, const std::string &  return_value_hex, bool parsable = true)
{
   ...
   at.act = upcxio::chain::action(
      std::vector<upcxio::chain::permission_level>{
         upcxio::chain::permission_level{
...
BOOST_AUTO_TEST_CASE(abi_to_variant__add_action__good_return_value)
{
   ...
   upcxio::chain::impl::abi_traverse_context ctx(abi_serializer::create_yield_function(max_serialization_time));
   upcxio::chain::impl::abi_to_variant::add(mvo, "action_traces", at, get_resolver(abidef), ctx);
...
BOOST_AUTO_TEST_CASE(transaction_extensions_tests)
{
   ...
   upcxio::chain::impl::abi_traverse_context ctx(abi_serializer::create_yield_function(max_serialization_time));
   auto abi = upcxio_contract_abi(fc::json::from_string(my_abi).as<abi_def>());
   upcxio::chain::impl::abi_to_variant::add(mvo, "test", txn, get_resolver(abi), ctx);
   ...
   upcxio::chain::impl::abi_to_variant::add(mvo2, "test", txn_clone, get_resolver(abi), ctx);
   ...
   upcxio::chain::impl::abi_to_variant::add(mvo3, "test", txn_clone2, get_resolver(abi), ctx);
