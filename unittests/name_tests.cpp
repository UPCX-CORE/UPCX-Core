...
try {
   ...
   BOOST_TEST( name{"upcxioacc"}.to_string() == "upcxioacc" );
   BOOST_TEST( name{"upcxioacco"}.to_string() == "upcxioacco" );
   BOOST_TEST( name{"upcxioaccou"}.to_string() == "upcxioaccou" );
   BOOST_TEST( name{"upcxioaccoun"}.to_string() == "upcxioaccoun" );
   BOOST_TEST( name{"upcxioaccount"}.to_string() == "upcxioaccount" );
   BOOST_TEST( name{"upcxioaccountj"}.to_string() == "upcxioaccountj" );
