#include <upcxio/upcxio.hpp>                   /* contract, datastream, check */
#include <upcxio/privileged.hpp>              /* blockchain_parameters */
...
#define IMPORT extern "C" __attribute__((upcxio_wasm_import))
...
class [[upcxio::contract("params_test")]] params_test : public upcxio::contract {
public:
   using upcxio::contract::contract;

   [[upcxio::action]] void maintest(){
