#include <upcx/upcx.hpp>                   /* contract, datastream, check */
#include <upcx/privileged.hpp>              /* blockchain_parameters */
...
#define IMPORT extern "C" __attribute__((upcx_wasm_import))
...
class [[upcx::contract("params_test")]] params_test : public upcx::contract {
public:
   using upcx::contract::contract;

   [[upcx::action]] void maintest(){
