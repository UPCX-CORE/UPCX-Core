...
extern "C" {
   void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
      if( code == "upcxio"_n.value && action == "onerror"_n.value ) {
         auto error = upcxio::onerror::from_current_action();
         upcxio::print("onerror called\n");
      ...
      //unhandled test call
      upcxio_assert( false, "Unknown Test ahhh!" );
