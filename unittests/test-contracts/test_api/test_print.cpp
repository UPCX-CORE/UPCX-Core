...
void test_print::test_printn() {
   printn(upcxio::name{"1"}.value);
   printn(upcxio::name{"5"}.value);
   printn(upcxio::name{"a"}.value);
   printn(upcxio::name{"z"}.value);

   printn(upcxio::name{"abc"}.value);
   printn(upcxio::name{"123"}.value);

   printn(upcxio::name{"abc.123"}.value);
   printn(upcxio::name{"123.abc"}.value);

   printn(upcxio::name{"12345abcdefgj"}.value);
   printn(upcxio::name{"ijklmnopqrstj"}.value);
   printn(upcxio::name{"vwxyz.12345aj"}.value);

   printn(upcxio::name{"111111111111j"}.value);
   printn(upcxio::name{"555555555555j"}.value);
   printn(upcxio::name{"aaaaaaaaaaaaj"}.value);
   printn(upcxio::name{"zzzzzzzzzzzzj"}.value);
}
