...
extern "C" __attribute__((upcx_wasm_import)) void set_wasm_parameters_packed(const void*, std::size_t);
...
class [[upcx::contract]] wasm_config_bios : public upcx::contract {
 public:
   using contract::contract;
   [[upcx::action]] void setwparams(const wasm_config& cfg) {
